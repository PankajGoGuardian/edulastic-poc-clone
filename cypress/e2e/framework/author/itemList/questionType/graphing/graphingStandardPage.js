class GraphingStandardPage {
  ...
  getGroupDeleteButton(groupName) {
    return this.getToolsContainer().contains('span', groupName).find('svg')
  }
  ...
  getAxisXSettingsContainer() {
    return this.getGridContainer().contains('Axis X').parent().parent()
  }

  getAxisYSettingsContainer() {
    return this.getGridContainer().contains('Axis Y').parent().parent()
  }
  ...
  getLabelsOnGraphTool(index) {
    return this.getGraphTools().eq(index).find('span')
  }
  ...
  getAxisLabelByNameOnBoard(index, name) {
    return this.getBoards().eq(index).contains('div.JXGtext', name)
  }
  ...
  getGraphPoints() {
    return cy
      .get('ellipse[fill="#00b2ff"][stroke="#00b2ff"]')
      .filter(':visible')
  }

  getGraphHollowPoints() {
    return cy
      .get('ellipse[fill="#ffffff"][stroke="#00b2ff"]')
      .filter(':visible')
  }

  getGraphCorrectAnswerPoints() {
    return cy
      .get('ellipse[fill="#ffcb00"][stroke="#ffcb00"]')
      .filter(':visible')
  }

  getGraphIncorrectPoints() {
    return cy
      .get('ellipse[fill="#ee1658"][stroke="#ee1658"]')
      .filter(':visible')
  }

  getGraphCorrectPoints() {
    return cy
      .get('ellipse[fill="#1fe3a1"][stroke="#1fe3a1"]')
      .filter(':visible')
  }

  getGraphCircles() {
    return cy
      .get('ellipse[fill="transparent"][stroke="#00b2ff"]')
      .filter(':visible')
  }
  ...
  clickOnStimulusH2Button() {
    return this.getStimulus().find('button.ql-header[value=2]').click()
  }
  ...
  selectTool(groupName, index, option) {
    ...
    cy.get(selectOp).scrollIntoView().should('be.visible').click()
  ...
  clickOnAddToolButton(groupName) {
    if (groupName) {
      cy.contains('div', groupName).find('button', 'ADD TOOL').click()
      return this
    }
  ...
  selectIgnoreRepeatedShapesOption(option) {
    ...
    cy.get('[data-cy="ignoreRepeatedShapes"]').should('be.visible').click()
  ...
  selectIgnoreLabelsOption(option) {
    ...
    cy.get('[data-cy="ignoreLabels"]').should('be.visible').click()
  ...
  selectStemNumerationOption(option) {
    ...
    cy.get('[data-cy="stemNumeration"]').should('be.visible').click()
  ...
  selectFontSizeOption(option) {
    ...
    cy.get('[data-cy="fontSize"]').should('be.visible').click()
  ...
  selectControlOption(index, option) {
    ...
    cy.get('[data-cy="controlSelect"]').eq(index).should('be.visible').click()
  ...
  clickOnResetButton() {
    cy.contains('Reset').eq(0).click()
    return this
  }

  clickOnTabsPlusButton() {
    this.getTabsContainer().find('button').click()
    return this
  }

  clickOnTab(index) {
    this.getTabsContainer().find('> div').eq(index).click()
    return this
  }
