...
describe(`${FileHelper.getSpecName(
  ...
  const schoolData = {
    ...
    existingSchools: [
      ...
      'Automation School - Regression Suite',
      'Automation School - Smoke Suite',
    ],
    zipSearch: '987654321',
  ...
  context(' > Search and select school', () => {
    ...
    it(' > Search school with Zip', () => {
      myProfile.clickOnAddSchool()
      myProfile.searchAndSelectSchool(
        schoolData.existingSchools[1],
        schoolData.zipSearch
      )
    })
    ...
    it(' > Search school with City', () => {
      myProfile.clickOnAddSchool()
      myProfile.searchAndSelectSchool(
        schoolData.existingSchools[2],
        schoolData.citySearch
      )
    })
