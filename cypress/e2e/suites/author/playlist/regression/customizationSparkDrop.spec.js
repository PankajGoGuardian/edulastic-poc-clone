  ...
  context.skip('>allowing customization- drop', () => {
    ...
    context('>edit module and add new module', () => {
      ...
      it(">customize-'create new module'", () => {
        ...
        playlistlibraryPage.addTestTab.setModuleGroupNameByModule(
          2,
          'module-group-3'
        )
      ...
      context('>verify student side', () => {
        ...
        it('>edited module and new module', () => {
          ...
          studentplaylistPage
            ...
            .should('contain.text', 'edited module')
    ...
    context('>verify and edit by owner', () => {
      ...
      it('>search playlist and verify', () => {
        ...
        for (const i of [1, 2]) {
          playlistlibraryPage.reviewTab
            .getTestsInModuleByModule(i)
            .should('have.length', 2)
          playlistlibraryPage.reviewTab
            .getModuleNameByModule(i)
            .should('have.text', `module-${i}`)
        }
      })
      it('>remove test', () => {
        playlistlibraryPage.header.clickOnEdit()
