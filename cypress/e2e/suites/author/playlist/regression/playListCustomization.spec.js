...
describe('Playlist customization', () => {
  ...
  context.skip('Search from search bar', () => {
    ...
    it('Search by Id', () => {
      ...
      playListCustomization.searchContainer.verifySearchResultVisible(
        `${testId.testId2}`
      )
    })
    it('Search By standard', () => {
      playListCustomization.searchContainer.typeInSearchBar(
  ...
  context.skip('search from Authored by me folder', () => {
    it('Verifiy grade,subject and status filter', () => {
      ...
      playListCustomization.searchContainer.VerififySearchResultNotVisible(
        `${testId.testId8}`
      )
      ...
      playListCustomization.searchContainer.setFilters({
        status: 'Published',
        subject: 'Mathematics',
      })
      playListCustomization.searchContainer.verifySearchResultVisible(
