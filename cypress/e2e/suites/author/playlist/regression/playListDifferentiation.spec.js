...
describe(`${FileHelper.getSpecName(
  ...
  const customizedTests = [
    {
      id: '5e78e3974b09d80007cbcc51',
      name: 'Test_for_Differentiation_tab_Review_Work',
      target: 'REVIEW',
    },
    {
      id: '5e78e48aa609890008de851e',
      name: 'Test for Differentiation Tab - Practice Work',
      target: 'PRACTICE',
    },
    {
      id: '5e78e54a1e75ab000741efd6',
      name: 'Test for Differentiation tab - for Challenge work',
      target: 'CHALLENGE',
    },
  ]
  ...
  context.skip('>Verify Differentiation Tab', () => {
    ...
    it('[TC02] > Verify Review Work and Challenge work Standards for each assignment', () => {
      assignmentMapping.forEach((element, index) => {
        ...
        differentiationPage
          ...
          .should(
            'have.length',
            standardMapping[index].challengeStandards.length
          )
      })
    })
    ...
    it('[TC03] > Verify Mastery Range Slider', () => {
      ...
      for (const value of practiceMasteryRange) {
        differentiationPage.setAndVerifyPracticeMasteryRange(
          value.masteryMin,
          value.MasteryMax
        )
