...
describe(`${FileHelper.getSpecName(
  Cypress.spec.name
)} >> Author "OrderList" type question`, () => {
  const queData = {
          ...
          .then(() => {
            ...
            question
              ...
              .then(() => {
                question
                  .getListInputs()
                  .should('have.length', queData.list.length)
              })
          })
      })
    })
    ...
    context(' > TC_90 => Preview Items', () => {
      ...
      it(' > Click on Show Answers', () => {
        preview
          ...
          .click()
          .then(() => {
            cy.get('body').children().contains('div', queData.list[0])
          })
      })
  ...
  context(' > Advanced Options', () => {
    ...
    describe(' > Layout', () => {
      it(' > should be able to select button list style and change layout', () => {
        ...
        cy.get('@select').scrollIntoView().should('be.visible').click()

        question.getButtonListStyleOption().should('be.visible').click()
      ...
      it(' > should be able to select list style and change layout', () => {
        ...
        question.getListStyleOption().should('be.visible').click()
      ...
      it(' > should be able to select inline style and change layout', () => {
        ...
        question.getInlineStyleOption().should('be.visible').click()
      ...
      it(' > should be able to select Uppercase Alphabet stem numeration', () => {
        ...
        question.getUppercaseAlphabetOption().should('be.visible').click()
      ...
      it(' > should be able to select Lowercase Alphabet stem numeration', () => {
        ...
        question.getLowercaseAlphabetOption().should('be.visible').click()
