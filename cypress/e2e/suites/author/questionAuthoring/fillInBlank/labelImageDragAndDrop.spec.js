...
describe(`${FileHelper.getSpecName(
  Cypress.spec.name
)} >> Author "Label Image with Drag & Drop" type question`, () => {
  const queData = {
  ...
  context(' > User creates question.', () => {
    ...
    context(' > [Tc_370]:Tc_1 => Upload image and verify options', () => {
      ...
      it(' > Width(px)', () => {
        ...
        question
          .getImageWidth()
          .should('have.css', 'width', `${queData.imageWidth}px`)
        question
      ...
      it(' > Height(px)', () => {
        ...
        question
          .getImageHeight()
          .should('have.css', 'height', `${queData.imageHeight}px`)
        question
          .getImageInPreviewContainer()
          .should('have.css', 'height', `${queData.imageHeight}px`)
      })
      ...
      it(' > Left(px)', () => {
        ...
        question
          .getImageInPreviewContainer()
          .should('have.css', 'left', `${queData.imagePosLeft}px`)
      })
      ...
      it(' > Top(px)', () => {
        ...
        question
          .getImageInPreviewContainer()
          .should('have.css', 'top', `${queData.imagePosTop}px`)
      })
    ...
    context(' > [Tc_371]:Tc_2 => verify additional options', () => {
      ...
      it(' > Edit ARIA labels', () => {
        question.getAriaLabelCheck().click().find('input').should('be.checked')
        cy.get('body').find('.iseditablearialabel').should('be.visible')
        question
          .getAriaLabelCheck()
          .click()
          .find('input')
          .should('not.be.checked')
        cy.get('body').find('.iseditablearialabel').should('not.be.visible')
      })
    ...
    context(' > [Tc_372]:Tc_3 => Possible responses block', () => {
      ...
      it(' > Edit the default text', () => {
        ...
        question
          ...
          .should('contain.text', queData.formattext)
    ...
    context(' > [Tc_373]:Tc_4 => Set Correct Answer(s)', () => {
      ...
      it(' > Check/uncheck Show Drag Handle', () => {
        ...
        question.getResponsesBox().each(($el) => {
          cy.wrap($el).find('i').should('not.be.visible')
        })
      })
