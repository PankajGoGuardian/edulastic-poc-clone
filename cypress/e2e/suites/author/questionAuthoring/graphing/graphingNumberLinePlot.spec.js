...
describe(`${FileHelper.getSpecName(
  Cypress.spec.name
)} >> Author "Number line with plot" type question`, () => {
  const queData = {
    group: 'Graphing',
  ...
  context(' > User creates question.', () => {
    ...
    it(' > Edit toolbar', () => {
      ...
      question.getSegmentsToolbar().children().should('have.length', 4)

      question.clickOnDeleteToolOnToolbar(1)

      question.getSegmentsToolbar().children().should('have.length', 3)
    ...
    it(' > Edit ticks', () => {
      ...
      question.getMinorTicks().clear().type(queData.ticks.minorTicks)
