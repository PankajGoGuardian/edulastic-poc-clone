...
describe(`${FileHelper.getSpecName(
  ...
  context(' > User creates question.', () => {
    ...
    it(' > Edit question text', () => {
      ...
      question.getQuestionEditor().find('h2').should('contain', queData.queText)

      question.getQuestionHeader().find('h2').should('contain', queData.queText)
    })

    it(' > Edit graph parameters', () => {
      question.getXMinParameter().clear().type(queData.graphParameters.xMin)

      question.getXMaxParameter().clear().type(queData.graphParameters.xMax)

      question.getYMinParameter().clear().type(queData.graphParameters.yMin)

      question.getYMaxParameter().clear().type(queData.graphParameters.yMax)
    ...
    it(' > Edit tools', () => {
      ...
      question
        .getGroupTools(queData.tools.defaultGroupName)
      ...
      question
        .getGroupDeleteButton(queData.tools.defaultGroupName)
        .should('have.length', 0)
      question
        .getToolDeleteButton(queData.tools.defaultGroupName, 0)
        .should('have.length', 0)
      ...
      question
        .clickOnNewGroupButton()
        .clickOnAddToolButton(queData.tools.groupName2)
      ...
      question.getCorrectAnswerGraphContainer().within(() => {
        question.getGraphTools().within(() => {
          ...
          question.getGraphToolsMainShapes().eq(0).should('contain', 'Point')
          question.getGraphToolsMainShapes().eq(1).should('contain', 'Ray')
          question.getGraphToolsMainShapes().eq(2).should('contain', 'Point')
          question.getGraphToolsMainShapes().eq(3).should('contain', 'Point')

          question.getGraphToolsMainShapes().eq(2).click()
          question
          ...
          question.getGraphToolsMainShapes().eq(3).click()
          question
            .getGraphToolsMainShapes()
            .eq(3)
            .within(() => {
      ...
      question.getCorrectAnswerGraphContainer().within(() => {
        question.getGraphTools().within(() => {
          ...
          question.getGraphToolsMainShapes().eq(0).should('contain', 'Point')
          question.getGraphToolsMainShapes().eq(1).should('contain', 'Point')

          question.getGraphToolsMainShapes().eq(1).click()
          question
            .getGraphToolsMainShapes()
            .eq(1)
            .within(() => {
    ...
    it('Edit layout', () => {
      question.getLayoutWidth().clear().type(queData.layout.width)

      question.getLayoutHeight().clear().type(queData.layout.height)

      question.getLayoutMargin().clear().type(queData.layout.margin)

      question.getLayoutSnapto().clear().type(queData.layout.snapTo)
    ...
    it(' > Edit grid', () => {
      question.getXDistance().clear().type(2)

      question.getXTickDistance().clear().type(2)
      ...
      question.getYDistance().clear().type(2)

      question.getYTickDistance().clear().type(2)
      ...
      question
        ...
        .then((length) => {
          for (let i = 0; i < length; i++) {
            question
              .getAxisLabelByNameOnBoard(i, queData.grid.xAxisLabel)
              .should('be.visible')
            question
              .getAxisLabelByNameOnBoard(i, queData.grid.yAxisLabel)
              .should('be.visible')
          }
        })
      ...
      question
        ...
        .then((length) => {
          for (let i = 0; i < length; i++) {
            question
              .getVisibleTickLabelsOnBoard(i, ',')
              .should('have.length', 0)
          }
        })

      question.getXDistance().clear().type(1000)

      question.getXTickDistance().clear().type(1000)

      question.getYDistance().clear().type(1000)

      question.getYTickDistance().clear().type(1000)

      question.getXMinParameter().clear().type(-3000)

      question.getXMaxParameter().clear().type(3000)

      question.getYMinParameter().clear().type(-2000)

      question.getYMaxParameter().clear().type(2000)
      ...
      question.getXDistance().clear().type(1)

      question.getXTickDistance().clear().type(1)

      question.getYDistance().clear().type(1)

      question.getYTickDistance().clear().type(1)
    ...
    it(' > Edit background image', () => {
      question.getBgImageUrl().clear().type(queData.bgImage.url)

      question.getBgImageHeight().clear().type(queData.bgImage.height)

      question.getBgImageWidth().clear().type(queData.bgImage.width)
      ...
      question.getBgImageOpacity().clear().type(queData.bgImage.opacity)
    ...
    it(' > Edit background shapes', () => {
      question.getBgShapesGraphContainer().within(() => {
        question.getGraphTools().within(() => {
          question.getGraphToolsMainShapes().eq(1).click({ force: true })
        })
      })

      question.invokeBoardClick(
        1,
        queData.bgShapes.point1.x,
        queData.bgShapes.point1.y
      )

      question.invokeBoardClick(
        1,
        queData.bgShapes.point2.x,
        queData.bgShapes.point2.y
      )
    ...
    it(' > Edit annotation', () => {
      question.getAnnotationTitle().clear().type(queData.annotation.title)

      question.getAnnotationLabelTop().clear().type(queData.annotation.labelTop)
    ...
    it(' > Edit correct answers', () => {
      question.getPointsParameter().clear().type(queData.correctAnswers.points)
      ...
      question
        .getPointsParameter()
        .should('have.value', queData.correctAnswers.points)
      question.clickOnTab(1)
      question
        .getPointsParameter()
        .should('have.value', queData.correctAnswers.alternatePoints)
