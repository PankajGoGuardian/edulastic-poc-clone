...
describe(`${FileHelper.getSpecName(
  Cypress.spec.name
)} >> Author "Highlight Image" type question`, () => {
  const queData = {
    group: 'Highlight',
  ...
  context(' > User creates question.', () => {
      ...
      it(' > Enter Width (px) and Height (px)', () => {
        ...
        question
          ...
          .should(
            'have.css',
            'background-size',
            `${queData.imageWidth}px ${queData.imageHeight}px`
          )
      })
    ...
    context(' > TC_241 => Preview', () => {
      ...
      it(' > Click on Clear', () => {
        preview.getClear().should('be.visible').click()
    ...
    context(" > Verify Drawing tool's in preview", () => {
      ...
      it('> Verify freedraw tool', () => {
        ...
        question
          .getDrawableElementInPreview()
          .trigger('mouseleave', { clientX: 300, clientY: 300 })
