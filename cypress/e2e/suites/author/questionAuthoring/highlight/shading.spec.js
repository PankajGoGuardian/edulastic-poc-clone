...
describe(`${FileHelper.getSpecName(
  ...
  describe(' > Shading', () => {
      ...
      describe(' > Layout', () => {
        ...
        it(' > should be able to select border type: Full', () => {
          ...
          question
            ...
            .find('li')
            .each(($el) => {
              cy.wrap($el).should('have.css', 'border-width').and('eq', '1px')
            })
        })
        it(' > should be able to select border type: None', () => {
          ...
          question
            ...
            .find('li')
            .each(($el) => {
              cy.wrap($el).should('have.css', 'border-width').and('eq', '0px')
            })
        })
        it(' > should be able to set 2 selection', () => {
          ...
          question
            ...
            .find('li')
            .each(($el, index) => {
              cy.wrap($el).should('be.visible').click().as('item')
    ...
    context(' > Score by location method', () => {
      before('visit items page and select question type', () => {
        editItem.createNewItem()
