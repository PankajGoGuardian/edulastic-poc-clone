...
describe(`${FileHelper.getSpecName(
  Cypress.spec.name
)} >> Author "Math Cloze" type question`, () => {
  const queData = {
    mockString: '10-5+8-4',
    group: 'Math',
  ...
  context(' > User creates question', () => {
    context(' > Math Cloze type question with one Response box', () => {
      ...
      context(
        ' > TC_553 => Enter question text in Compose Question text box',
        () => {
          ...
          it(' > give external link', () => {
            ...
            editToolBar.link().first().click()
            question.getSaveLink().first().click()
            question
          ...
          it(' > Upload image to server', () => {
            question.getComposeQuestionTextBox().first().focus()

            question.getUploadImageIcon().first().click()
            cy.uploadFile(
              'testImages/sample.jpg',
              'input.ql-image[type=file]'
            ).then(() =>
              question.getEditorData().find('img').should('be.visible')
            )

            question.getComposeQuestionTextBox().first().clear()
          })
        }
      )
      ...
      context(' > TC_556 => equivSymbolic method', () => {
        ...
        it(' > Testing Value', () => {
          ...
          question.checkMathClozeCorrectAnswer(
            expected,
            preview,
            input.length,
            true
        ...
        it(' > Testing check/uncheck Ignore text check box', () => {
          const {
            ...
            checkboxValues,
            isCirrectAnsver,
          } = queData.equivSymbolic.ignoreText
        ...
        it(' > Testing significant decimal places', () => {
          const {
            ...
            expected,
            decimalPlaces,
          } = queData.equivSymbolic.significantDecimal

          question.setValue(input, 0)
          question.setArgumentInput(
        ...
        it(' > Combination of methods ignoreText and significantDecimalPlaces', () => {
          const {
            ...
            decimalPlaces,
            expected,
          } = queData.equivSymbolic.combinationIgnoreTxt
        ...
        it(' > Combination of methods setDecimalSeparator', () => {
          ...
          question
            ...
            .contains('div', decimalSeparators)
      ...
      context(' > TC_557 => equivLiteral method', () => {
        ...
        it(' > Testing check/uncheck Allow interval check box', () => {
          const {
            ...
            checkboxValues,
            isCorrectAnswer,
          } = queData.equivLiteral.allowInterval
        ...
        it(' > Testing check/uncheck Ignore order check box', () => {
          ...
          question.checkUncheckMathClozeChecbox(
            preview,
            input,
            expected,
            checkboxValues,
      ...
      context(' > TC_558 => equivValue method', () => {
        ...
        it(' > Testing significant decimal places', () => {
          const {
            ...
            expected,
            decimalPlaces,
          } = queData.equivValue.significantDecimal
      ...
      context(' > TC_559 => isSimplified method', () => {
        ...
        it(' > Testing inverse result', () => {
          const {
            ...
            isCorrectAnswer,
            checkboxValues,
          } = queData.isSimplified.simplifiedVersion
      ...
      context(' > TC_562 => isUnit method', () => {
        ...
        it(' > Testing with allow decimal marks', () => {
          const {
            ...
            input,
            units,
          } = queData.isUnit.setThousandsSeparator
      ...
      context(' > TC_572 => Combination of methods', () => {
        ...
        it(' > Combination of methods setThousandsSeparator - Space and Comma', () => {
          const {
            ...
            thousands,
            separators,
          } = queData.combination.setThousandsSeparator
        ...
        it(' > Combination of methods setDecimalSeparator', () => {
          const {
            ...
            decimalSeparators,
            thousandsSeparators,
          } = queData.combination.setDecimalSeparator
        ...
        it(' > Combination of methods significantDecimalPlaces', () => {
          const {
            ...
            isCorrectAnswer,
            decimalPlaces,
          } = queData.combination.significantDecimalPlaces
      ...
      context(' > TC_564 =>  stringMatch method', () => {
        ...
        it(' > Testing with literal string comparison', () => {
          const {
            input,
            expected,
          } = queData.stringMatch.literalStringComparison
    ...
    context(' > Math Cloze type question with two Response boxes', () => {
      ...
      context(' > TC_567 => equivSymbolic method', () => {
        ...
        it(' > Testing check/uncheck Ignore text check box', () => {
          ...
          question.setAndCheckMathClozeCorrectAnswer(
            ignoreText,
            preview,
            responseBoxQuantity
          )
        ...
        it(' > Testing significant decimal places', () => {
          const {
            ...
            expected,
            decimalPlaces,
          } = queData.equivSymbolicTwoResponse.significantDecimal

          question.getLastCollapseItem().last().click()
      ...
      context(' > TC_569 => equivValue method', () => {
        ...
        it(' > Testing with tolerance that will be deemed as correct', () => {
          const {
            ...
            tolerance,
            isCorrectAnswer,
          } = queData.equivValueTwoResponse.tolerance
          const { responseBoxQuantity } = queData
