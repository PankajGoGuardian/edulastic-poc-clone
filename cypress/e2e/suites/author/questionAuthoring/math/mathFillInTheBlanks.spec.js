...
describe(`${FileHelper.getSpecName(
  Cypress.spec.name
)} >> Author "Math – fill in the blanks" type question`, () => {
  const queData = {
    mockString: '10-5+8-4',
    group: 'Math',
  ...
  context(' > User creates question', () => {
    ...
    context(' > TC_429 => Enter the text/inputs to Template Markup', () => {
      it(' > On click of template box a latex keyboard should appear', () => {
        question
          .getMathquillBlockId()
          .then((inputElements) => {
            expect(inputElements[0].innerText).to.equal(
              'R\nRESPONSE\n+\nR\nRESPONSE\n=\nR\nRESPONSE'
            )
          })
          .first()
    ...
    context(' > TC_490 => equivLiteral method', () => {
      ...
      it(' > Testing check/uncheck Ignore order check box', () => {
        ...
        question.checkUncheckChecboxFill(
          preview,
          input,
          expected,
          checkboxValues,
    ...
    context(' > TC_413 => Preview Items', () => {
      ...
      it(' > Click on Check answer', () => {
        previewItems
          ...
          .click()
          .then(() =>
            question.getBody().children().should('contain', 'score: 0/1')
          )
      })
