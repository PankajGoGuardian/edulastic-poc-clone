 ...
 */
    ...
    it(' > [Tc_303]:test => Set Correct Answer(s)', () => {
      ...
      // multiple response
      question.getMultipleResponse().find('input').should('be.checked')
 ...
 */
  ...
  context(
    ' > [sanity]:test => Create question using different options and validate',
    () => {
  ...
  context('Score block testing', () => {
      ...
      preview
        ...
        .then(() => {
          question.checkHighlightData({
            color: 'right',
            length: 2,
            choices: [queData.correct[0], queData.correct[1]],
          })
        })
    ...
    it('Verify alternate answer', () => {
      ...
      question.checkHighlightData({
        color: 'right',
        length: 2,
        choices: [queData.alterate[0], queData.alterate[1]],
      })
