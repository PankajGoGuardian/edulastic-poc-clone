const testdata = [
  ...
  ["M_93", "x^2+3,3x", "", "isFactorised:setDecimalSeparator=','", "false"],
  ...
  ["M_363", "1 + x > 2", "2 - x < 1", "symbolic:compareSides", "false"],
  ["M_401", "{x | x<2}", "(-\\infty,2)", "literal", "false"],
  ["M_402", "{x | 1>x<2}", "(-\\infty,2)", "symbolic", "false"],
  ["M_405", "{x | x<2} = {x | x > 2}", "{x | x<2} = {x | x > 2}", "symbolic", "true"],
  ...
  [
    "M_483",
    "\\begin{bmatrix}1&4&0\\end{bmatrix}*\\begin{bmatrix}2\\\\-1\\\\5\\end{bmatrix}=\\begin{bmatrix}-2\\end{bmatrix}",
    "\\begin{bmatrix}1&4&0\\end{bmatrix}*\\begin{bmatrix}2\\\\-1\\\\5\\end{bmatrix}=\\begin{bmatrix}-2\\end{bmatrix}",
    "symbolic:compareSides",
    "true"
  ],
  ["M_487", "\\$129", "\\$128", "symbolic", "false"],
  ...
  ["M_523", "\\frac{d}{dx}(2x+1)^3", "6(4x^2+4x+1)", "symbolic", "true"],
  ...
  ["M_585", "-3,3", "3,-3", "value:setEvaluation", "true"],
  ["M_586", "-6,-3,3", "3,-3", "value:setEvaluation", "false"],
  ["M_587", "-6,-3,3", "3,6,-3", "value:setEvaluation", "false"],
  ...
  ["M_616", "1,2,3", "(1,2,3)", "symbolic", "true"],
  ["M_618", "2,1,3", "(1,2,3)", "symbolic", "false"],
