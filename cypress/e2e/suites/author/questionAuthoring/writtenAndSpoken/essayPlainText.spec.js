...
describe(`${FileHelper.getSpecName(Cypress.spec.name)} >> Author "Essay with plain text" type question`, () => {
  ...
  context(" > User creates question", () => {
    ...
    context(" > [essay_p_s5] => preview - verify cut copy paste option settings", () => {
    ...
    context(" > [essay_p_s6] => Display block tests", () => {
      ...
      it(" > Min height and Max Height", () => {
        ...
        question.header.preview();
        question.getPreviewBoxContainer().should("have.attr", "minheight", "500");
        question.getPreviewBoxContainer().should("have.attr", "maxheight", "500");
      });
      ...
      it(" > Verify PlaceHolder", () => {
        ...
        question.header.preview();
        question.getPreviewBoxContainer().should("have.attr", "placeholder", queData.placeHolder);
      });
