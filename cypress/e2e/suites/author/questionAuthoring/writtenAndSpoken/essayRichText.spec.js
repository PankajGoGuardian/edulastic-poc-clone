...
describe(`${FileHelper.getSpecName(
  Cypress.spec.name
)} >> Author "Essay with rich text" type question`, () => {
  const queData = {
  ...
  context(' > User creates question.', () => {
    ...
    context(
      ' > [essay_rich_s1] => User creates question and update points.',
      () => {
    ...
    context(
      ' > [essay_rich_s2] => Preview - verify Word Limit visibility',
      () => {
        ...
        it('> Verify visiblity on limit', () => {
          ...
          for (i in words) {
            ...
            if (i < 3) {
              ...
              question
                .getWordCount()
                .should('have.css', 'color', queColor.LIGHT_RED2)
            }
          }
        })
    ...
    context(' > [essay_p_s5] => Display block tests', () => {
      ...
      it(' > Verify PlaceHolder', () => {
        ...
        question
          ...
          .should('have.text', queData.placeHolder)
      })
    ...
    context(
      ' > [essay_rich_s6] => Preview -Verify Default toolbar options',
      () => {
    ...
    context(' > [essay_rich_s7] => Verify Toolbar Options', () => {
      ...
      Cypress._.keys(alignOptions).forEach((key) => {
        it(`Verify ${key} option`, () => {
          ...
          question
            .getTextInPreview()
            .should('have.css', 'text-align', alignOptions[key])
        })
      })
      ...
      it('Verify blockquote option', () => {
        ...
        blockQuoteOptions.forEach((options) => {
          question.getToolBarOptionInPreview('quote').eq(0).click()
          ...
          if (options == 'increase') {
            ...
            question
              .getTextEditor()
              .should('not.contain', blockQuote.quote, queData.testText)
          }
        })
      })
      ...
      it('Verify indentation Option', () => {
        ...
        Cypress._.keys(indentation).forEach((key) => {
          ...
          if (key == 'indent') {
            question
              .getTextInPreview()
              .should('have.css', 'margin-left', indentation[key])
          } else {
            question
              .getTextInPreview()
              .should('not.have.css', 'margin-left', indentation[key])
          }
        })
      })
      ...
      it('verify table options', () => {
        ...
        question
          ...
          .then(() => {
            ...
            question.getTextEditor().find('table').should('have.length', 1)
          })
      })
    })

    context(
      ' > [essay_rich_s8] =>Verify undo,redo and clear format options',
      () => {
        before('Select required toolbars and do the required actions', () => {
          ...
          // Actions
          const clearOptionsToolBarsRequired = [
            'bold',
            'italic',
            'underline',
            'clearFormatting',
          ...
          question
            .getTextEditor()
            .type(`{selectAll}${queData.testText}{selectAll}`)
        ...
        it('Verify undo Option', () => {
          ...
          question
            ...
            .should(
              'not.contain',
              toolBarOptionsWithTags.underline,
              queData.testText
            )
        })
