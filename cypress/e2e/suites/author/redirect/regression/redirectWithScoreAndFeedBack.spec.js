...
const students = {
  1: {
    email: 'student.scoreandfeed@snapwiz.com',
    stuName: 'student1',
  },
  2: {
    email: 'student2.scoreandfeed@snapwiz.com',
    stuName: 'student2',
  },
}
...
const redirectTestData = {
  className: 'Class',
  teacher: 'teacher.scoreandfeed@snapwiz.com',
...
describe(`${FileHelper.getSpecName(Cypress.spec.name)} >> Redirect`, () => {
  ...
  const testId = '5f620ee7013cf10008e2aac4'
  ...
  describe(`> redirect with setting - ${redirectType.STUDENT_SCORE_AND_FEEDBACK}`, () => {
    ...
    it(' > redirect the student and verify card view', () => {
      ...
      lcb.redirectPopup.selectRedirectPolicy(
        redirectType.STUDENT_SCORE_AND_FEEDBACK
      )
