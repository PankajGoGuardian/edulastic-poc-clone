...
describe(`>${FileHelper.getSpecName(
  Cypress.spec.name
)}> regrade settings- 'Answer On Paper'`, () => {
  ...
  const students = {
    class1: {
      1: {
        email: 's1.c1.regrade.ansonpaper@snapwiz.com',
        status: studentSide.IN_PROGRESS,
        name: 'Stu1Class1',
      },
      2: {
        email: 's2.c1.regrade.ansonpaper@snapwiz.com',
    ...
    class2: {
      1: {
        email: 's1.c2.regrade.ansonpaper@snapwiz.com',
        status: studentSide.IN_PROGRESS,
        name: 'Stu1Class2',
      },
      2: {
        email: 's2.c2.regrade.ansonpaper@snapwiz.com',
        status: studentSide.NOT_STARTED,
        name: 'Stu2Class2',
      },
    },
