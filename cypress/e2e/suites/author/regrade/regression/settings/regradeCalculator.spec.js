...
describe(`>${FileHelper.getSpecName(
  ...
  const students = {
    class1: {
      1: {
        email: 's1.c1.regrade.calculator@snapwiz.com',
        status: studentSide.SUBMITTED,
        name: 'Stu1Class1',
      },
      2: {
        email: 's2.c1.regrade.calculator@snapwiz.com',
        status: studentSide.IN_PROGRESS,
        name: 'Stu2Class1',
      },
      3: {
        email: 's3.c1.regrade.calculator@snapwiz.com',
    ...
    class2: {
      1: {
        email: 's1.c2.regrade.calculator@snapwiz.com',
        status: studentSide.SUBMITTED,
        name: 'Stu1Class2',
      },
      2: {
        email: 's2.c2.regrade.calculator@snapwiz.com',
        status: studentSide.IN_PROGRESS,
        name: 'Stu2Class2',
      },
      3: {
        email: 's3.c2.regrade.calculator@snapwiz.com',
        status: studentSide.NOT_STARTED,
        name: 'Stu3Class2',
      },
    },
