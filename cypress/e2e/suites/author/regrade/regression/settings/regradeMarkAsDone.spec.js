...
describe(`>${FileHelper.getSpecName(
  ...
  const students = {
    class1: {
      1: {
        email: 's1.c1.regrade.markasdone@snapwiz.com',
        status: studentSide.SUBMITTED,
        name: 'Stu1Class1',
      },
      2: {
        email: 's2.c1.regrade.markasdone@snapwiz.com',
    ...
    class2: {
      1: {
        email: 's1.c2.regrade.markasdone@snapwiz.com',
        status: studentSide.SUBMITTED,
        name: 'Stu1Class2',
      },
      2: {
        email: 's2.c2.regrade.markasdone@snapwiz.com',
        status: studentSide.IN_PROGRESS,
        name: 'Stu2Class2',
      },
    },
    ...
    */
    ...
    context('> edit settings and regrade', () => {
      ...
      ;[attemptsdata1, attemptsdata2].forEach((studentsdata, index) => {
        it(`> verify 'mark as done' in lcb for '${
          index === 1 ? '' : 'not '
        }overidden' assignment`, () => {
          testlibaryPage.sidebar.clickOnAssignment()
          authorAssignmentPage.clickOnLCBbyTestId(
            versionedTest1,
            index === 0 ? assignmentid1 : assignmentid2
          )
