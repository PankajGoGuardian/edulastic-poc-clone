...
describe(`>${FileHelper.getSpecName(
  ...
  const students = {
    class1: {
      1: {
        email: 's1.c1.regrade.maxattempt@snapwiz.com',
        status: studentSide.SUBMITTED,
        name: 'Stu1Class1',
      },
      2: {
        email: 's2.c1.regrade.maxattempt@snapwiz.com',
    ...
    class2: {
      1: {
        email: 's1.c2.regrade.maxattempt@snapwiz.com',
        status: studentSide.SUBMITTED,
        name: 'Stu1Class2',
      },
      2: {
        email: 's2.c2.regrade.maxattempt@snapwiz.com',
        status: studentSide.IN_PROGRESS,
        name: 'Stu2Class2',
      },
    },
        ...
        context(
          ...
          () => {
            ...
            it('> verify exress grader', () => {
              ...
              attemptData.forEach((stu, ind) => {
                expressGraderPage.getGridRowByStudent(stu.name)
                expressGraderPage.verifyResponseEntryByIndexOfSelectedRow(
                  'B',
                  'Q1'
                )
              })
