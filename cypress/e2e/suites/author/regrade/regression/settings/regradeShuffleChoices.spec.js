...
describe(`>${FileHelper.getSpecName(
  ...
  const students = {
    class1: {
      1: {
        email: 's1.c1.regrade.shuffle.choices@snapwiz.com',
        status: studentSide.SUBMITTED,
        name: 'Stu1Class1',
      },
      2: {
        email: 's2.c1.regrade.shuffle.choices@snapwiz.com',
        status: studentSide.IN_PROGRESS,
        name: 'Stu2Class1',
      },
      3: {
        email: 's3.c1.regrade.shuffle.choices@snapwiz.com',
    ...
    class2: {
      1: {
        email: 's1.c2.regrade.shuffle.choices@snapwiz.com',
        status: studentSide.SUBMITTED,
        name: 'Stu1Class2',
      },
      2: {
        email: 's2.c2.regrade.shuffle.choices@snapwiz.com',
        status: studentSide.IN_PROGRESS,
        name: 'Stu2Class2',
      },
      3: {
        email: 's3.c2.regrade.shuffle.choices@snapwiz.com',
        status: studentSide.NOT_STARTED,
        name: 'Stu3Class2',
      },
    },
  ...
  let versionedTest1
  let versionedTest2
  const originalSequence = ['right-1', 'wrong-1', 'wrong-2', 'right-2']
