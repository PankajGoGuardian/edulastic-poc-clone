...
describe(`>${FileHelper.getSpecName(
  Cypress.spec.name
)}> regrade settings- 'assessment players'`, () => {
  ...
  const students = {
    class1: {
      1: {
        email: 's1.c1.regrade.player@snapwiz.com',
        status: studentSide.SUBMITTED,
        name: 'Stu1Class1',
      },
      2: {
        email: 's2.c1.regrade.player@snapwiz.com',
        status: studentSide.IN_PROGRESS,
        name: 'Stu2Class1',
      },
      3: {
        email: 's3.c1.regrade.player@snapwiz.com',
    ...
    class2: {
      1: {
        email: 's1.c2.regrade.player@snapwiz.com',
        status: studentSide.SUBMITTED,
        name: 'Stu1Class2',
      },
      2: {
        email: 's2.c2.regrade.player@snapwiz.com',
        status: studentSide.IN_PROGRESS,
        name: 'Stu2Class2',
      },
      3: {
        email: 's3.c2.regrade.player@snapwiz.com',
        status: studentSide.NOT_STARTED,
        name: 'Stu3Class2',
      },
    },
    ...
    */
    before('> assign without/with overiding', () => {
      ...
      testlibaryPage.header.clickOnPublishButton().then((id) => {
        ...
        testlibaryPage.assignPage.selectStudentPlayerSkinByOption(
    ...
    context('> edit settings and regrade', () => {
      before('> login as teacher', () => {
        ...
        testlibaryPage.testSettings.selectStudentPlayerSkinByOption(
