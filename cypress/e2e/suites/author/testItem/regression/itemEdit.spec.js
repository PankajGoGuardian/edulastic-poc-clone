...
describe(`${FileHelper.getSpecName(
  Cypress.spec.name
)} >>Test Edit-Items after and Before use`, () => {
    ...
    it('verify in review tab', () => {
      ...
      itemIds.forEach((id, i) => {
        testReviewTab
          ...
          .should('not.have.value', UPDATED_POINTS[i].toString())
        testReviewTab
          .getPointsOnQueCardByid(id)
          .should('have.value', points[i].toString())
      })
    })
  ...
  context('Edit Before Use/Attempt-- correct ans', () => {
    ...
    it(' Login As student and verify points', () => {
      ...
      itemsInTest.forEach((item, index) => {
        ...
        reportsPage
          .getAchievedScore()
          .should('have.text', points[index].toString())
      })
    })
  })
