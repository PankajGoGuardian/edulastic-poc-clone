...
describe(`${FileHelper.getSpecName(
  Cypress.spec.name
)}> item metadata page verification`, () => {
    ...
    standardMaps.forEach((standardMap, index) => {
      ...
      context(`> standard map-${index + 1}`, () => {
        ...
        it('> verify standard set and grade in standard search dropdown', () => {
          ...
          metadataPage.verifySubjectAndGradeInStandardSearchOption(
            stadardSet,
            grade
          )
        })
        ...
        it('> associated standards in dropdown', () => {
          ...
          standardToselect.forEach((standard) =>
            metadataPage.verifySelectedStandards(standard)
          )
        })
      })
    })
    ...
    standardMaps.forEach((standardMap, index) => {
      ...
      context(`> standard browsing -${index + 1}`, () => {
        ...
        it('> grades dropdown in standard browsing', () => {
          ...
          grade.forEach((gra) =>
            metadataPage.verifySelectedGradeInBrowseStandards(gra)
          )
        })
  ...
  context('> save and publish item with all options', () => {
    ...
    it('> verify metadata page of published item', () => {
      ...
      standardToselect.forEach((sta) =>
        metadataPage.verifySelectedStandards(sta)
      )
    ...
    it('> add some more standards and verify', () => {
      ...
      metadataPage.selectStandardSetInBrowseStandards(
        standardMaps[1].stadardSet
      )
