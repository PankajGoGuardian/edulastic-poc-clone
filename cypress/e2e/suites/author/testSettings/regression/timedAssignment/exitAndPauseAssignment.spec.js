...
describe(`${FileHelper.getSpecName(
  Cypress.spec.name
)}>> timed assignment -exit and puase test`, () => {
  ...
  context('>exit -test', () => {
    context('>when exit is disabled', () => {
      ...
      it(">verify at student side-'no exist'", () => {
        ...
        studentTestPage
          .verifyAndGetRemainingTime('00:00:50', 10)
          .then((startTime) => {
    ...
    context('>when exit is enabled', () => {
      ...
      context(">verify at student side-'allow exit'", () => {
        before('>login', () => {
          cy.login('student', user.student1, user.pass)
          studentAssignmentsPage.verifyTimeAvalableForTestById(
            customtestid,
            customtestTime
          )
          studentAssignmentsPage.clickOnAssigmentByTestId(customtestid, {
        ...
        it(">attempt-1 -'exit'", () => {
          studentTestPage.waitWhileAttempt('00:00:10')
          studentTestPage
            .verifyAndGetRemainingTime('00:02:50', 10)
            .then((startTime) => {
        ...
        it(">attempt-2 -'re-attempt and exit'", () => {
          ...
          studentTestPage
            .verifyAndGetRemainingTime('00:01:50', 10)
            .then((startTime) => {
    ...
    context('>open test verify student side', () => {
      ...
      it(">verify student side-'assignment is paused'", () => {
        ...
        studentTestPage
          .verifyAndGetRemainingTime('00:01:50', 10)
          .then((startTime) => {
            studentTestPage.waitWhileAttempt(
              `00:${startTime / 60}:${startTime - 60}`
            )
            studentTestPage.clickOkOnTimeOutPopUp()
          })
      })
