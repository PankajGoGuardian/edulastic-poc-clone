...
describe(`${FileHelper.getSpecName(
  ...
  context(' > Assignment attempt and stats', () => {
    ...
    context(
      ' > 1st attempt - test assessment player,attempt all questions and submit the test,validate',
      () => {
        it(' > Check Assignment Status', () => {
          assignmentPage.validateAssignment(
            assignmentName,
            asgnstatus.notstarted,
            buttonText.start
          )
        ...
        it(' > Check every question', () => {
          ...
          // right ans
          test.dragAndDropInsideQuestion(
            DefinedAnswers.right,
            DefinedIndex.right
          )
          ...
          test
            .getQuestionBoxByIndex(DefinedIndex.right)
            .contains('div', DefinedAnswers.right)
          test
            .getQuestionBoxByIndex(DefinedIndex.wrong)
            .contains('div', DefinedAnswers.wrong)
          test.checkAnsValidateAsRight()
          ...
          test.checkAnsValidateAsWrong()
          // right ans
          test.imageDragAndDropInsideQuestion(
            DefinedAnswers.right,
            DefinedIndex.right
          )
          ...
          // check preserved status
          test
            .getLabelImageQuestionByIndex(DefinedIndex.right)
            .contains('div', DefinedAnswers.right)
          test
            .getLabelImageQuestionByIndex(DefinedIndex.wrong)
            .contains('div', DefinedAnswers.wrong)
          test
            .getLabelImageQuestionByIndex(DefinedIndex.other)
            .contains('div', DefinedAnswers.other)
          ...
          test.clickImageDropDownByIndex(
            DefinedAnswers.wrong,
            DefinedIndex.right
          )
    ...
    context(
      ' > 2nd attempt - attempt questions,submit the test,validate stats',
      () => {
        it(' > Check every question', () => {
          test = assignmentPage.clickOnAssignmentButton()
          ...
          // validate stats
          reportsPage.validateAssignment(
            assignmentName,
            asgnstatus.sub,
            buttonText.review
          )
