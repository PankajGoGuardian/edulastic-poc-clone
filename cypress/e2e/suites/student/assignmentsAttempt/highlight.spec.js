    ...
    context(
      ...
      () => {
        ...
        it(' > Attempt Q2 - Shading', () => {
          ...
          test.browserBack()
          test
            .getShadeItemByIndex(0)
            .should('have.css', 'background-color', selectedShadeColor)
          test
            .getShadeItemByIndex(5)
            .should('have.css', 'background-color', selectedShadeColor)
          test.checkAnsValidateAsRight()
        ...
        it(' > Attempt Q3 - Hotspot', () => {
          ...
          test.browserBack()
          test
            .getHotspotPolygonByIndex(0)
            .should('have.css', 'stroke', selectedHotspotColor)
          test.checkAnsValidateAsRight()
        ...
        it(' > Attempt Q4 - Token Highlight', () => {
          ...
          test.browserBack()
          test
            .getHighlightToken(DefinedAnswers.right)
            .should('have.class', 'active-word')
          test.checkAnsValidateAsRight()
    ...
    context(
      ...
      () => {
        ...
        it(' > Attempt Q4 - Token Highlight', () => {
          ...
          test.browserBack()
          test
            .getHighlightToken(DefinedAnswers.wrong)
            .should('not.have.class', 'active-word')
          test.checkAnsValidateAsWrong()
        })
        ...
        it(' > Check report', () => {
          ...
          assignmentPage
            .getReviewButton()
            .should('have.text', buttonText.review)
