...
describe(`${FileHelper.getSpecName(Cypress.spec.name)}`, () => {
  ...
  context('lcb page', () => {
    const pageURL =
      'author/classboard/5e4be3c32bf8c60007b637bf/5e4a9616823e850007661f3b'
  ...
  context('express grader page', () => {
    const pageURL =
      'author/expressgrader/5e4be3c32bf8c60007b637bf/5e4a9616823e850007661f3b'
    ...
    SCREEN_SIZES.forEach((size) => {
      it(`when resolution is '${size}'`, () => {
        ...
        if (size[0] < screenSizes.MAX_TAB_WIDTH)
          cy.contains('Question & Standard').should(
  ...
  context('standard performance page', () => {
    const pageURL =
      'author/standardsBasedReport/5e4be3c32bf8c60007b637bf/5e4a9616823e850007661f3b'
