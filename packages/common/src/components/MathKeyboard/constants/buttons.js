...
export const mixedFraction = {
  ...
  value: 'mixedFraction',
  label: <CustomImage src={Group941} width={39} height={39} />,
  types: ['all'],
  numToMove: 3,
  command: 'write',
}
...
export const mixedSqrt = {
  handler: '\\sqrt[{}]{}',
  label: <CustomImage src={Group999} />,
  types: ['all'],
  numToMove: 2,
  command: 'write',
}
...
export const degree = {
  handler: '\\degree',
  label: <CustomImage src={Group2740} width={24} height={28} />,
  labelcy: 'degree',
  types: ['all'],
  command: 'cmd',
}
...
export const v_dot = {
  handler: '\\vdots',
  label: <CustomImage src={Group8888} width={6} height={25} />,
  types: ['all'],
  command: 'cmd',
  name: 'vdots',
}
...
export const l_dots = {
  handler: '\\ldots',
  label: <CustomImage src={Group8889} width={25} height={6} />,
  types: ['all'],
  command: 'cmd',
  name: 'ldots',
}
...
export const d_dots = {
  handler: '\\ddots',
  label: <CustomImage src={Group8890} width={22} height={22} />,
  types: ['all'],
  command: 'cmd',
  name: 'ldoddotsts',
}
...
export const upper_mu = {
  handler: 'Μ',
  label: <CustomImage src={Path3415} width={18} height={17} />,
  types: ['all'],
  command: 'cmd',
  name: 'Mu',
}
...
export const upper_nu = {
  handler: 'Ν',
  label: <CustomImage src={Path3421} width={14} height={17} />,
  types: ['all'],
  command: 'cmd',
  name: 'Nu',
}
...
export const upper_omicron = {
  handler: 'Ο',
  label: <CustomImage src={Path3434} width={16} height={17} />,
  types: ['all'],
  command: 'cmd',
  name: 'Omicron',
}
...
export const bmatrix = {
  handler: '\\bmatrix',
  label: <CustomImage src={Group1004} width={38} height={22} />,
  types: ['all'],
  command: 'cmd',
  name: 'bmatrix',
}
...
export const bmatrix_v_one = {
  ...
  label: <CustomImage src={Group1008} width={28} height={28} />,
  types: ['all'],
  command: 'write',
  name: 'bmatrix',
}
...
export const bmatrix_h_one = {
  handler: '\\begin{bmatrix}{}&{}\\end{bmatrix}',
  label: <CustomImage src={Group1009} width={38} height={13} />,
  types: ['all'],
  command: 'write',
  name: 'bmatrix',
}
...
export const bmatrix_three = {
  handler: '\\begin{bmatrix}{}&{}&{}\\\\{}&{}&{}\\\\{}&{}&{}\\end{bmatrix}',
  label: <CustomImage src={Group1005} width={40} height={28} />,
  types: ['all'],
  command: 'write',
  name: 'tripleMatrix',
}
