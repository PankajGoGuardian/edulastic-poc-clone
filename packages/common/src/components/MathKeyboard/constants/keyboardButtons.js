...
const OPERATORS = [
  {
    handler: '+',
    label: (
      <CustomImage src={Group2735} width={12} height={12} role="presentation" />
    ),
  ...
  },
  {
    handler: '-',
    label: (
      <CustomImage src={Group2737} width={12} height={8} role="presentation" />
    ),
    types: ['basic', 'basic_wo_number', 'intermediate'],
    command: 'write',
  },
  ...
  },
  {
    handler: '\\div',
    label: (
      <CustomImage src={Group2788} width={12} height={12} role="presentation" />
    ),
    command: 'cmd',
    types: [
      'all',
...
const BASIC = [
  {
    handler: '=',
    label: (
      <CustomImage src={Equal} width={10} height={7} role="presentation" />
    ),
  ...
  },
  {
    handler: '<',
    label: (
      <CustomImage src={LessThan} width={9} height={10} role="presentation" />
    ),
    types: ['basic', 'intermediate'],
    command: 'cmd',
  },
  ...
  },
  {
    ...
    labelcy: '|',
    label: (
      <CustomImage src={Group993} role="presentation" width={30} height={22} />
    ),
    types: ['basic'],
    command: 'cmd',
  },
...
const BASIC_WO_NUMBER = [
  ...
  },
  {
    ...
    labelcy: 'sqrt',
    label: (
      <CustomImage src={Sqrt} width={25} height={13} role="presentation" />
    ),
  ...
  },
  {
    handler: '\\sqrt[3]{}',
    label: (
      <CustomImage src={Group1043} role="presentation" width={32} height={32} />
    ),
    types: ['basic_wo_number'],
    command: 'write',
  },
  ...
  },
  {
    handler: '\\pi',
    label: (
      <CustomImage src={GroupPi} width={13} height={11} role="presentation" />
    ),
    types: ['basic_wo_number'],
    command: 'cmd',
  },
...
const INTERMEDIATE = [
  ...
  },
  {
    handler: '\\pm',
    label: (
      <CustomImage src={Group2475} width={11} height={14} role="presentation" />
    ),
    types: ['intermediate'],
    command: 'cmd',
  },
  {
    handler: '≥',
    label: (
      <CustomImage src={Group6199} role="presentation" width={9} height={12} />
    ),
    types: ['intermediate'],
    command: 'cmd',
  },
  {
    handler: '≤',
    label: (
      <CustomImage src={Group4065} role="presentation" width={9} height={12} />
    ),
    types: ['intermediate'],
    command: 'cmd',
  },
  ...
  },
  {
    handler: '\\degree',
    label: (
      <CustomImage src={Group2739} width={8} height={8} role="presentation" />
    ),
    labelcy: 'degree',
    types: ['intermediate'],
    command: 'cmd',
...
const GEOMETRY = [
  {
    handler: '\\perp',
    label: (
      <CustomImage src={Group3171} width={16} height={16} role="presentation" />
    ),
    types: ['all', 'geometry'],
    command: 'cmd',
  },
  {
    handler: '\\angle',
    label: (
      <CustomImage src={Group2744} width={12} height={12} role="presentation" />
    ),
    types: ['all', 'geometry'],
    command: 'write',
  },
  {
    handler: '\\triangle',
    label: (
      <CustomImage src={Group3169} width={16} height={16} role="presentation" />
    ),
    types: ['all', 'geometry'],
    command: 'write',
  },
  ...
  },
  {
    handler: '\\parallel',
    label: (
      <CustomImage src={Group3163} width={16} height={16} role="presentation" />
    ),
    types: ['all', 'geometry'],
    command: 'cmd',
  },
  {
    handler: '\\text{m}\\angle',
    label: (
      <CustomImage src={Group6101} width={24} height={24} role="presentation" />
    ),
    types: ['all', 'geometry'],
    command: 'write',
  },
  {
    handler: '\\odot',
    label: (
      <CustomImage src={Group3170} width={16} height={16} role="presentation" />
    ),
    types: ['all', 'geometry'],
    command: 'write',
  },
  {
    handler: '\\theta',
    label: (
      <CustomImage src={Group2478} width={14} height={14} role="presentation" />
    ),
    types: ['all', 'geometry'],
    command: 'cmd',
  },
  {
    handler: '\\nparallel',
    label: (
      <CustomImage src={Group3181} width={16} height={16} role="presentation" />
    ),
    types: ['all', 'geometry'],
    command: 'cmd',
  },
  {
    handler: '\\sim',
    label: (
      <CustomImage src={Group3167} width={16} height={16} role="presentation" />
    ),
    types: ['all', 'geometry'],
    command: 'write',
  },
  {
    ...
    label: (
      <CustomImage src={Group3172} width={24} height={24} role="presentation" />
    ),
    types: ['all', 'geometry'],
    command: 'write',
  },
  {
    handler: '\\equiv',
    label: (
      <CustomImage src={Group2751} width={12} height={12} role="presentation" />
    ),
    types: ['geometry'],
    command: 'cmd',
  },
  ...
  },
  {
    handler: '\\cong',
    label: (
      <CustomImage src={Group3168} width={12} height={12} role="presentation" />
    ),
    types: ['all', 'geometry'],
    command: 'write',
  },
  ...
  },
  {
    handler: '\\square',
    label: (
      <CustomImage src={Group3180} width={16} height={16} role="presentation" />
    ),
    types: ['all', 'geometry'],
    command: 'write',
  },
