...
export const NUMBER_PAD_ITEMS = [
  {
    value: '1',
    label: (
      <CustomImage src={number1} width={6} height={14} role="presentation" />
    ),
  },
  {
    value: '2',
    label: (
      <CustomImage src={number2} width={8} height={14} role="presentation" />
    ),
  },
  {
    value: '3',
    label: (
      <CustomImage src={number3} width={8} height={14} role="presentation" />
    ),
  },
  {
    value: '4',
    label: (
      <CustomImage src={number4} width={10} height={15} role="presentation" />
    ),
  },
  {
    value: '5',
    label: (
      <CustomImage src={number5} width={8} height={14} role="presentation" />
    ),
  },
  {
    value: '6',
    label: (
      <CustomImage src={number6} width={8} height={14} role="presentation" />
    ),
  },
  {
    value: '7',
    label: (
      <CustomImage src={number7} width={8} height={14} role="presentation" />
    ),
  },
  {
    value: '8',
    label: (
      <CustomImage src={number8} width={8} height={14} role="presentation" />
    ),
  },
  {
    value: '9',
    label: (
      <CustomImage src={number9} width={8} height={14} role="presentation" />
    ),
  },
  {
    value: '0',
    label: (
      <CustomImage src={number0} width={8} height={14} role="presentation" />
    ),
  },
  {
    value: '.',
    label: <CustomImage src={dot} width={5} height={5} role="presentation" />,
  },
  {
    handler: '/',
    labelcy: 'divide',
