module.exports = {
  ...
  playerSkinTypes: {
    ...
    peaks: 'PEAKS',
    acap: 'ACAP',
    act_aspire: 'ACT Aspire',
    azm2: 'AzM2',
    csde: 'CSDE',
    dcas: 'DCAS',
    fsa: 'FSA',
    georgia_milestones: 'Georgia Milestones',
    smarter_balanced: 'Smarter Balanced',
    isasp: 'ISASP',
    isat: 'ISAT',
    iar: 'IAR',
    ilearn: 'iLearn',
    ...
    nscas: 'NSCAS',
    nh_sas: 'NH SAS',
    nj_state_assesment: 'NJ State Assesment',
    nm_mesa: 'NM MESA',
    nv_ready: 'NV Ready',
    ny_regents: 'NY Regents',
    ohio_state_tests: "Ohio's State Tests",
    ostp: 'OSTP',
    osa: 'OSA',
    pssa: 'PSSA',
    ricas: 'RICAS',
    sc_ready: 'SC Ready',
    tcap_tnready: 'TCAP / TNReady',
    staar: 'STAAR',
    ut_rise: 'UT RISE',
    sol: 'SOL',
    wcap: 'WCAP',
    wsas_forward: 'WSAS / Forward',
    wv_assessments: 'WV Assessments',
    wy_topp: 'WY-TOPP',
