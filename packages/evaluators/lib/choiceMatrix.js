  ...
  return function(_ref) {
    ...
    switch (scoring_type) {
      case _scoring.ScoringType.EXACT_MATCH:
        return (0, _exactMatchTemplate.default)((0, _countExactMatchScores.default)("innerDifference"), {
      ...
      default:
        return (0, _partialMatchTemplate.default)((0, _countPartialMatchScores.default)("innerDifference"), {
          userResponse: userResponse,
          answers: answers,
          validation: validation
        });
