...
var exactMatchEvaluator = function exactMatchEvaluator(_ref, answers, _ref2) {
  ...
  try {
    for (var _iterator = answers[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      ...
      if ((0, _lodash.isEqual)(userResponse, answerValue)) {
...
var getCount = function getCount(rows) {
  return rows.reduce(function (acc) {
...
var partialMatchEvaluator = function partialMatchEvaluator(_ref4, answers, _ref5) {
  ...
  var _maxBy = (0, _lodash.maxBy)(result, function (res) {
    return res.score;
  }),
      score = _maxBy.score,
      evaluation = _maxBy.evaluation;
...
var evaluator = function evaluator(_ref6) {
  var _ref6$userResponse = _ref6.userResponse,
      userResponse = _ref6$userResponse === void 0 ? {
    value: []
  } : _ref6$userResponse,
