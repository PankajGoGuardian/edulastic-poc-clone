  ...
  <SVG xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25.014 15.331" {...props}>
    <g transform="translate(0 0)">
      <path
        ...
        strokeWidth="2.5"
      />
      <g transform="translate(7.262 0)" fill={themeColor} stroke={themeColor} strokeWidth="1">
        <circle cx="2.017" cy="2.017" r="2.017" stroke="none" />
        <circle cx="2.017" cy="2.017" r="1.517" fill="none" />
      </g>
      <g transform="translate(0 11.296)" fill={themeColor} stroke={themeColor} strokeWidth="1">
        <circle cx="2.017" cy="2.017" r="2.017" stroke="none" />
        <circle cx="2.017" cy="2.017" r="1.517" fill="none" />
      </g>
      <g transform="translate(20.979 0)" fill={themeColor} stroke={themeColor} strokeWidth="1">
        <circle cx="2.017" cy="2.017" r="2.017" stroke="none" />
        <circle cx="2.017" cy="2.017" r="1.517" fill="none" />
      </g>
      <g transform="translate(13.717 11.296)" fill={themeColor} stroke={themeColor} strokeWidth="1">
        <circle cx="2.017" cy="2.017" r="2.017" stroke="none" />
        <circle cx="2.017" cy="2.017" r="1.517" fill="none" />
      </g>
    </g>
