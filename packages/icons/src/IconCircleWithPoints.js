  ...
  >
    <g transform="translate(-0.402 0)">
      ...
      <g transform="translate(10.347 0) rotate(45)">
        <g transform="translate(0 0)" strokeWidth="1">
          <circle cx="2.017" cy="2.017" r="2.017" stroke="none" />
          <circle cx="2.017" cy="2.017" r="1.517" fill="none" />
        </g>
        <g transform="translate(0.571 10.599)" strokeWidth="1">
          <circle cx="2.017" cy="2.017" r="2.017" stroke="none" />
          <circle cx="2.017" cy="2.017" r="1.517" fill="none" />
        </g>
        <g transform="translate(11.189 0.571)" strokeWidth="1">
          <circle cx="2.017" cy="2.017" r="2.017" stroke="none" />
          <circle cx="2.017" cy="2.017" r="1.517" fill="none" />
        </g>
        <g transform="translate(11.189 10.599)" strokeWidth="1">
          <circle cx="2.017" cy="2.017" r="2.017" stroke="none" />
          <circle cx="2.017" cy="2.017" r="1.517" fill="none" />
        </g>
      </g>
