...
const IconClear = props => (
  <SVG xmlns="http://www.w3.org/2000/svg" width="16.86" height="20.022" viewBox="0 0 16.86 20.022" {...props}>
    <g transform="translate(0 0)">
      ...
      />
      <rect className="a" width="13.33" height="2.167" transform="translate(2.568 17.855)" />
    </g>
  </SVG>
);
