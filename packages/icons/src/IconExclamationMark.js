...
const IconExclamationMark = props => (
  <SVG xmlns="http://www.w3.org/2000/svg" viewBox="0 0 12.527 12.527" {...props}>
    <g transform="translate(0.001 0)">
      <path fill="#de0b83" d="M0,6.263a6.264,6.264,0,1,1,6.263,6.264A6.282,6.282,0,0,1,0,6.263Z" />
      <path
        fill="#fff"
