  ...
  <SVG xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15.212 20" {...props}>
    <g transform="translate(-41.895)">
      <path
        ...
        fill="#fff"
      />
      <path d="M41.9,300.457c0-.165,0-.046,0,0Z" transform="translate(0 -283.208)" fill="#fff" />
      <path d="M308.085,301.636c0-.045,0-.313,0,0Z" transform="translate(-250.979 -284.258)" fill="#fff" />
      <path
