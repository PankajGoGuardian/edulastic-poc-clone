...
const IconBookMark = withIconStyles((props) => (
  ...
  >
    <g transform="translate(-33.261)">
      <path
        d="M48.083.588a1.326,1.326,0,0,0-.617-.482A1.3,1.3,0,0,0,46.949,0H34.625a1.3,1.3,0,0,0-.517.106,1.325,1.325,0,0,0-.617.482,1.248,1.248,0,0,0-.229.729V16.474a1.249,1.249,0,0,0,.229.729,1.325,1.325,0,0,0,.617.482,1.3,1.3,0,0,0,.517.106A1.4,1.4,0,0,0,35.6,17.4l5.186-4.986L45.973,17.4a1.4,1.4,0,0,0,.976.376,1.368,1.368,0,0,0,1.135-.576,1.247,1.247,0,0,0,.229-.729V1.317A1.248,1.248,0,0,0,48.083.588ZM46.807,16.11l-4.974-4.774-1.047-1-1.047,1L34.766,16.11V1.505H46.807v14.6Z"
        fill="#d4d4d4"
      />
    </g>
  </SVG>
