...
const IconSquare = props => (
  <SVG xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18.807 18.024" {...props}>
    <g transform="translate(0.001 0)">
      <g transform="translate(1.614 1.719)" fill="none" stroke={props.color || themeColor} strokeWidth="2">
      ...
      <g transform="translate(0 0)">
        ...
        <circle cx="2.351" cy="2.351" r="2.351" transform="translate(0 13.322)" />
        <circle cx="2.351" cy="2.351" r="2.351" transform="translate(14.106 0)" />
        <circle cx="2.351" cy="2.351" r="2.351" transform="translate(14.106 13.322)" />
      </g>
    </g>
  </SVG>
);
