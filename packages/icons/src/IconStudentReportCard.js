  ...
  >
    <g transform="translate(17.023 -436.001)">
      ...
      <g transform="translate(-17.023 436.001)">
        ...
        />
        <path
          d="M41.9,300.43c0-.113,0-.032,0,0Z"
          transform="translate(-41.895 -288.574)"
          fill="#434b5d"
        />
        <path
          d="M308.085,301.589c0-.031,0-.215,0,0Z"
          transform="translate(-297.63 -289.644)"
          fill="#434b5d"
        />
        <path
