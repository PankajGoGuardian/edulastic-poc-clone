...
const IconTranslator = props => (
  <SVG xmlns="http://www.w3.org/2000/svg" width="30px" height="20px" viewBox="0 0 48 48" {...props}>
...
export default withIconStyles(IconTranslator);
