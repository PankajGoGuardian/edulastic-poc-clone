      ...
      <div className="edu-emoji-wrapper hand">
        {isClose ? (
          ...
          <span className="edu-emoji">
            {(EMOJI_BY_TONE[toneId] && EMOJI_BY_TONE[toneId][emoji]) ||
              EMOJI[emoji]}
          </span>
        )}
      </div>
      <img
        src={avatar || `https://api.adorable.io/avatars/126/${deviceId}.png`}
        alt={fullname}
