...
const AudioTagPlayer = ({user}) => {
    ...
    return (
        <Container>
            <Heading title="Built on howler.js and custom components">Edulastic - Audio Tag Player</Heading>
            <PlayerContainer>
                <PlayerBtnsContainer>
                    {showPlayBtn ? (
            ...
            <br/><br/><br/> 
            <Heading title="Built with HTML5 audio element">Browser - Audio Tag Player</Heading>
