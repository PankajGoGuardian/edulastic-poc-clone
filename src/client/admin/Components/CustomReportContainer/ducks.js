...
const UPDATE_CUSTOM_REPORT_REQUEST_ERROR = "[custom-reports] update custom report error";

const CREATE_CUSTOM_REPORT_REQUEST = "[custom-reports] create custom report request";
const CREATE_CUSTOM_REPORT_REQUEST_SUCCESS = "[custom-reports] create custom report success";
const CREATE_CUSTOM_REPORT_REQUEST_ERROR = "[custom-reports] create custom report error";
...
export const updatePermissionStatusAction = createAction(UPDATE_PERMISSION_STATUS_REQUEST);

export const updateCustomReportAction = createAction(UPDATE_CUSTOM_REPORT_REQUEST);

export const createCustomReportAction = createAction(CREATE_CUSTOM_REPORT_REQUEST);
...
export const setSelectedReportDataAction = createAction(SET_SELECTED_REPORT_DATA);
...
function* getCustomReportRequest({ payload }) {
  try {
    const customReportList = yield call(customReportApi.getCustomReports, payload);
    yield put({
...
function* updatePermissionStatusRequest({ payload }) {
  try {
    const permissionStatus = yield call(customReportApi.updatePermissionStatus, payload);
    yield put({
...
function* updateCustomReportRequest({ payload }) {
  try {
    const updatedReport = yield call(customReportApi.updateCustomReport, payload);
    yield put({
...
export function* customReportForDistrictSaga() {
  yield all([
    ...
    yield takeEvery(UPDATE_PERMISSION_STATUS_REQUEST, updatePermissionStatusRequest),
