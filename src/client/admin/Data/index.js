...
export const questionTypes = [
  ...
  'Match Table - Standard (Choice Matrix)',
  'Match Table - Inline (Choice Matrix)',
  'Match Table - Labels (Choice Matrix)',
  'Drag & Drop (Cloze with Drag & Drop)',
  'Text Drop down (Cloze Drop down)',
  'Text Entry (Cloze with Text)',
  ...
  'Sort List',
  'Classification',
  'Match the Following (Match List)',
  'Re-sequence (order List)',
  'Essay with Rich Text',
  'Essay with Plain Text',
  'Short Text',
  'Drawing Response (HighLight Image)',
  'Shading',
  'Hotspot',
  'Sentence Response (Token Highlight)',
  'Expression & Formula',
  'Numeric Entry',
  ...
  'Line Plot - NumberLine (Range Plotter)',
  'Passage With Questions',
  'Combinational Multipart',
]
