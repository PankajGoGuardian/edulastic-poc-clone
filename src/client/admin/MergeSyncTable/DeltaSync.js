      ...
      <Form onSubmit={handleSubmit} {...formItemLayout}>
        <Form.Item>
          {getFieldDecorator('studentDeltaMergeEnabled', {
            ...
            <CheckboxLabel>
              {deltaSyncConfig.studentDeltaMergeEnabled}
            </CheckboxLabel>
          )}
        </Form.Item>
        <Form.Item>
          {getFieldDecorator('studentFullMergeEnabled', {
            ...
            <CheckboxLabel>
              {deltaSyncConfig.studentFullMergeEnabled}
            </CheckboxLabel>
          )}
        </Form.Item>
        <Form.Item label={deltaSyncConfig.studentMergeAttribute}>
          {getFieldDecorator(
            'studentMergeAttribute',
            {}
          )(
        ...
        <Form.Item>
          {getFieldDecorator('teacherDeltaMergeEnabled', {
            ...
            <CheckboxLabel>
              {deltaSyncConfig.teacherDeltaMergeEnabled}
            </CheckboxLabel>
          )}
        </Form.Item>
        <Form.Item>
          {getFieldDecorator('teacherFullMergeEnabled', {
            ...
            <CheckboxLabel>
              {deltaSyncConfig.teacherFullMergeEnabled}
            </CheckboxLabel>
          )}
        </Form.Item>
        <Form.Item label={deltaSyncConfig.teacherMergeAttribute}>
          {getFieldDecorator(
            'teacherMergeAttribute',
            {}
          )(
            <Select style={{ width: 120 }}>
              <Option value="name">Username</Option>
