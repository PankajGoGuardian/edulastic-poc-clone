    ...
    if (question && question.annotations) {
      ...
      annotations.forEach((annotation, i) => {
        if (
          ...
          prevProps.question.annotations[i].size.width !==
            annotation.size.width &&
          prevProps.question.annotations[i].size.height !==
            annotation.size.height
        ) {
          const { width = 120, height = 80 } = annotation.size || {
            width: 120,
            height: 80,
          }
      ...
      <>
        {annotations
          ...
          .map((annotation, i) => {
            ...
            let { width = 120, height = 80 } = annotation.size || {
              width: 120,
              height: 80,
            }
            ...
            const content = (
              <MathSpan dangerouslySetInnerHTML={{ __html: value }} noPadding />
            )
              ...
              >
                <Container noBorder {...this.props} isRnd>
                  <ValueWrapper isOverHight={isOverHight}>
                    ...
                    {showPopover && (
                      <Ellipsis noPadding top="unset" bottom="2px" />
                    )}
                    {!showPopover && content}
                  </ValueWrapper>
                </Container>
