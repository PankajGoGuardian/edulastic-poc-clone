...
class MoreOptionsSettings extends Component {
  ...
  getDefaultFontSizeItem = () => {
    ...
    const isCurrentFontSizeItemUndefined = currentFontSizeItem &&
      currentFontSizeItem.selected === undefined;
  ...
  changeFontSize = (e) => {
    ...
    const findItem = fontSizeList.find(fzItem =>
      fzItem.value.toLowerCase() === value.toLowerCase());
  ...
  changeFractionsFormat = (e) => {
    ...
    const findItem = fractionsFormatList.find(fractionItem =>
      fractionItem.value.toLowerCase() === value.toLowerCase());
