...
class GraphDisplay extends Component {
  ...
  shouldComponentUpdate(nextProps, nextState){
    ...
    if(inLCB && this.props?.graphData &&  isEqual(nextProps?.graphData?.activity,this.props?.graphData?.activity) && isEqual(nextProps?.bgShapes , this.props?.bgShapes) && (this.props.tReady === nextProps.tReady) && (this.props.windowHeight === nextProps.windowHeight)){
      return false;
    }
