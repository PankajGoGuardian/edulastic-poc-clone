...
export const LOAD_PREVIOUS_RESPONSES_REQUEST = "[test] load previous responses request";
...
// QuestionCommon
export const QUESTIONCOMMON_UPDATE_QUESTIONS_LIST = "[QuestionCommon] QUESTIONCOMMON_UPDATE_QUESTIONS_LIST";
...
export const QUESTIONCOMMON_UPDATE_ALT_VALIDATION_SCORE = "[QuestionCommon] QUESTIONCOMMON_UPDATE_ALT_VALIDATION_SCORE";
...
export const LOAD_TEST_LEVEL_USER_WORK = "[testUserWork] load testlevel userWork";
