...
const DropArea = ({ updateData, item, showIndex = true, setQuestionData, disable, isDropDown, containerRef }) => {
  ...
  const handleDragging = d => {
    ...
    const imageW = imageWidth ? imageWidth + imageLeft : imageOriginalWidth + imageLeft;
    const imageH = imageHeight ? imageHeight + imageTop : imageOriginalHeight + imageTop;
