...
export const CustomSelect = styled(Select)`
  ...
  .ant-select-selection__choice {
    ...
    background-color: ${(props) =>
      props.theme.questionMetadata.antSelectSelectionSelectedValueBackground};
  }

  .ant-select-selection__choice__content {
    font-size: ${(props) =>
      props.theme.questionMetadata.antSelectSelectionChoiceContentFontSize};
    font-weight: ${(props) =>
      props.theme.questionMetadata.antSelectSelectionChoiceContentFontWeight};
    color: ${(props) =>
      props.theme.questionMetadata.antSelectSelectionSelectedValueColor};
