...
StemNumeration.defaultProps = {
  ...
  options: [
    {
      value: 'numerical',
      label: i18n.t('assessment:component.options.numerical'),
    },
    {
      value: 'uppercase',
      label: i18n.t('assessment:component.options.uppercasealphabet'),
    },
    {
      value: 'lowercase',
      label: i18n.t('assessment:component.options.lowercasealphabet'),
    },
  ],
}
