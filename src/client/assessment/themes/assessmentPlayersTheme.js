...
export const playersTheme = {
  default: {
    ...
    headerButtonBorderHoverColor: themeColor,
  ...
  brandBlue: "#00b0ff",
  brandGreen: "#1fe3a1",
  brandDarkgreen: "#4aac8b",
  brandRed: "#ee1658",
  brandYellow: "#f4a700",
  brandDarkergrey: "#444444",
  brandDarkgrey: "#cfcfcf",
  brandGrey: "#e5e5e5",
  ...
  CheckAnswerButtonText: "#ffffff",
  CheckAnswerButtonBg: "#40a9ff",
  NextPrevButtonTextColor: "#ffffff",
  NextPrevButtonBg: "#40a9ff",
  timeDurationTextColor: "#756e6e",
  saveIconBgColor: "#e2e2e2",
  PracticePlayer: {
    logoColor: "0eb08d",
    "": ""
  },
