...
GridlinesOption.defaultProps = {
  ...
  options: [
    {
      value: SHOW_GRIDLINES_BOTH,
      label: i18n.t('assessment:component.chart.showGridlinesOptions.both'),
    },
    {
      value: SHOW_GRIDLINES_X_ONLY,
      label: i18n.t('assessment:component.chart.showGridlinesOptions.x_only'),
    },
    {
      value: SHOW_GRIDLINES_Y_ONLY,
      label: i18n.t('assessment:component.chart.showGridlinesOptions.y_only'),
    },
    {
      value: SHOW_GRIDLINES_NONE,
      label: i18n.t('assessment:component.chart.showGridlinesOptions.none'),
    },
  ],
}
