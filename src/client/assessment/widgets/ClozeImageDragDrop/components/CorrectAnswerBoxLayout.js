      ...
      <b style={{ fontSize }}>
        {title ? (
          <span
            style={{
              color:
                theme.widgets.clozeImageDragDrop.correctAnswerBoxSubtitleColor,
            }}
          >
            {title}
          </span>
          ...
          <>
            <span
              style={{
                color:
                  theme.widgets.clozeImageDragDrop.correctAnswerBoxTitleColor,
              }}
            >
            ...
            <div style={{ display: 'flex', height: '100%' }}>
              ...
              <span
                ...
                style={{
                  ...
                  fontWeight:
                    theme.widgets.clozeImageDragDrop
                      .correctAnswerBoxTextContainerFontWeight,
                  width: 'auto',
                  background:
                    theme.widgets.clozeImageDragDrop
                      .correctAnswerBoxTextContainerBgColor,
                  minHeight: '40px',
                  minWidth: '35px',
                }}
              >
...
export default withTheme(
  React.memo(withNamespaces('assessment')(CorrectAnswerBoxLayout))
)
