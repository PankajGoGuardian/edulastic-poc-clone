          ...
          >
            <Subtitle
              id={getFormattedAttrId(
                `${item?.title}-${t(
                  'component.cloze.imageDropDown.composequestion'
                )}`
              )}
            >
                  ...
                  {!item.imageUrl && (
                    <Dragger {...uploadProps}>
                      ...
                      <p
                        ...
                        style={{
                          color:
                            theme.widgets.clozeImageDropDown.antUploadHintColor,
                        }}
                      >
                        <strong>
                          {t('component.cloze.imageDropDown.dragAndDrop')}
                        </strong>
                      </p>
                      <h2
                      ...
                      >
                        {t('component.cloze.imageDropDown.orBrowse')}: PNG, JPG,
                        GIF (1024KB MAX.)
                      </p>
                    </Dragger>
                  )}
