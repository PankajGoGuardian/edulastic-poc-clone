  ...
  onSortEnd({ oldIndex, newIndex }) {
    ...
    setQuestionData(
      produce(questionData, (draft) => {
        draft.distractorRationaleOptions = arrayMove(
  ...
  addNewChoiceBtn() {
    ...
    setQuestionData(
      produce(questionData, (draft) => {
        ...
        draft.distractorRationaleOptions.push(
  ...
  render() {
    ...
    return (
      <PaddingDiv bottom={30}>
        <Heading>
          {t('component.cloze.imageDropDown.additionaloptions')}
        </Heading>
        <Row>
          <Col md={12}>
            ...
            <TextField
              ...
              onChange={(e) =>
                this.changeStimulus('stimulusReviewonly', e.target.value)
              }
          ...
          <Col md={12}>
            ...
            <TextField
              ...
              containerStyle={{ width: '80%' }}
              onChange={(e) =>
                this.changeStimulus('instructorStimulus', e.target.value)
              }
        ...
        <Row>
          <Col md={6}>
            ...
            <TextField
              ...
              containerStyle={{ width: '80%' }}
              onChange={(e) =>
                this.changeStimulus('rubricReference', e.target.value)
              }
        ...
        <Row>
          <Col md={12}>
            ...
            <TextField
              disabled={false}
              onChange={(e) =>
                this.changeStimulus('sampleAnswer', e.target.value)
              }
        ...
        <Row>
          <Col md={12}>
            ...
            <TextField
              disabled={false}
              onChange={(e) =>
                this.changeStimulus('distractorRationale', e.target.value)
              }
