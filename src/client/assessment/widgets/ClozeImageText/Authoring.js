          ...
          >
            <Subtitle
              id={getFormattedAttrId(
                `${item?.title}-${t(
                  'component.cloze.imageText.composequestion'
                )}`
              )}
            >
            ...
            <FormContainer data-cy="top-toolbar-area">
              <FieldWrapper>
                <ImageWidthInput
                  ...
                  value={imageWidth}
                  onChange={(value) =>
                    this.changeImageDimensions('width', value)
                  }
                />
                <Label top={6} left={20}>
              ...
              <FieldWrapper>
                <ImageWidthInput
                  ...
                  value={imageHeight}
                  onChange={(value) =>
                    this.changeImageDimensions('height', value)
                  }
                />
                <Label top={6} left={20}>
              ...
              <CheckContainer position="unset" alignSelf="center">
                <CheckboxLabel
                  ...
                  onChange={(val) =>
                    this.onItemPropChange('keepAspectRatio', val.target.checked)
                  }
                >
            ...
            <FlexContainer
              style={{
                padding: 0,
                background:
                  theme.widgets.clozeImageText.controlBarContainerBgColor,
                  ...
                  {!item.imageUrl && (
                    <Dragger {...uploadProps}>
                      ...
                      <p
                        ...
                        style={{
                          color:
                            theme.widgets.clozeImageText.antUploadHintColor,
                        }}
                      >
                        <strong>
                          {t('component.cloze.imageText.dragAndDrop')}
                        </strong>
                      </p>
                      <h2
                        ...
                        style={{
                          color:
                            theme.widgets.clozeImageText.antUploadTextColor,
                        }}
                      >
                      ...
                      >
                        {t('component.cloze.imageText.orBrowse')}: PNG, JPG, GIF
                        (1024KB MAX.)
                      </p>
                    </Dragger>
                  )}
              ...
              <PaddingDiv top={30}>
                <>
                  ...
                  <Row gutter={24}>
                    <Col span={24}>
                      <Label>
                        {t('component.cloze.imageText.imagealtertext')}
                      </Label>
                      <TextInputStyled
              ...
              <PaddingDiv key={`${option}_${index}`}>
                ...
                <SortableList
                  ...
                  onChange={(itemIndex, e) =>
                    this.editOptions(index, itemIndex, e)
                  }
                />
                <PaddingDiv>
