...
class Layout extends Component {
  ...
  render() {
    ...
    const addIndividual = () => {
      ...
      const resp = responsecontainerindividuals.map(
        (responsecontainerindividual) => {
          if (
            !flag &&
            responsecontainerindividual.id &&
      ...
      if (flag) {
        ...
        onChange('uiStyle', {
          ...uiStyle,
          responsecontainerindividuals: resp.sort(
      ...
      if (_response) {
        ...
        onChange('uiStyle', {
          ...uiStyle,
          responsecontainerindividuals: responsecontainerindividuals.sort(
            (r1, r2) => r1.index - r2.index
          ),
        })
      }
          ...
          <Row gutter={24}>
            <Col md={12}>
              <CheckboxLabel
                ...
                onChange={(e) =>
                  changeUiStyle('globalSettings', e.target.checked)
                }
              >
                  ...
                  <Row gutter={24}>
                    <Col md={12}>
                      ...
                      <TextInputStyled
                        ...
                        value={
                          responsecontainerindividual.widthpx || uiStyle.widthpx
                        }
                      />
                    </Col>
                    <Col md={12}>
                      ...
                      <TextInputStyled
                        ...
                        value={
                          responsecontainerindividual.heightpx ||
                          uiStyle.heightpx
                        }
                      />
                    </Col>
                    ...
                    <Col md={12}>
                      ...
                      <SelectWrapper>
                        <Select
                          ...
                          onChange={handleIndividualTypeChange.bind(
                            this,
                            index
                          )}
                          options={[
                            {
                              value: 'text',
                              label: t('component.options.text'),
                            },
                            {
                              value: 'number',
                              label: t('component.options.number'),
                            },
                          ]}
