    ...
    >
      <Subtitle
        id={getFormattedAttrId(
          `${item?.title}-${t('component.coding.codeDisplayOptions.title')}`
        )}
        showIcon
      >
      ...
      <Row>
        <Col span={24}>
          <RadioLabelGroup onChange={onChange} value={item.layout}>
            <RadioLabel
              value={t('component.coding.codeDisplayOptions.leftright')}
            >
              {t('component.coding.codeDisplayOptions.leftright')}
            </RadioLabel>
            <RadioLabel
              value={t('component.coding.codeDisplayOptions.topbottom')}
            >
