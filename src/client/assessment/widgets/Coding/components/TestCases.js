    ...
    >
      <Subtitle
        id={getFormattedAttrId(
          `${item?.title}-${t('component.coding.testCases.title')}`
        )}
        textStyles={{
          width: '100%',
          display: 'flex',
      ...
      <Row>
        <RadioLabelGroup
          onChange={onChange}
          value={item.testCaseEvaluationType}
        >
          <RadioLabel value="auto">
            {t('component.coding.testCases.evaluationOptions.auto')}
          </RadioLabel>
          <RadioLabel value="manual">
            {t('component.coding.testCases.evaluationOptions.manual')}
          </RadioLabel>
        </RadioLabelGroup>
      ...
      {showAddTestCaseModal && (
        <TestCaseForm
          onClose={toggleAddNewTestCase}
          onSave={handleUpsertTestCase}
          item={itemToEdit}
        />
      )}
    </Question>
