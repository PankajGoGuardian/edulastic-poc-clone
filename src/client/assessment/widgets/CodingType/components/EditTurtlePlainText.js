...
import ComposeQuestionTurtle from './ComposeQuestionTurtle'
...
EditTurtleQuestion.defaultProps = {
...
export default withNamespaces('assessment')(EditTurtleQuestion)
