...
const MathFormulaAnswerMethod = ({
  ...
  const syntaxes = [
    ...
    { value: syntaxesConst.SIMPLE_FRACTION, label: t('component.math.simpleFraction') },
    { value: syntaxesConst.MIXED_FRACTION, label: t('component.math.mixedFraction') },
    { value: syntaxesConst.EXPONENT, label: t('component.math.exponent') },
    { value: syntaxesConst.STANDARD_FORM, label: t('component.math.standardForm') },
    { value: syntaxesConst.SLOPE_INTERCEPT_FORM, label: t('component.math.slopeInterceptForm') },
    { value: syntaxesConst.POINT_SLOPE_FORM, label: t('component.math.pointSlopeForm') }
  ];
