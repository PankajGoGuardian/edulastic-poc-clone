...
const MathFormulaAnswerMethod = ({
  ...
  const warningFlag =  !!options.setThousandsSeparator && !!options.setDecimalSeparator && options.setThousandsSeparator[0] === options.setDecimalSeparator[0] && options.setThousandsSeparator[0] === ".";
