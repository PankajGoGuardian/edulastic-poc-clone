      ...
      >
        <Subtitle
          id={getFormattedAttrId(
            `${item?.title}-${t('component.shading.canvasSubtitle')}`
          )}
        >
        ...
        <Row gutter={24}>
          <Col span={12}>
            ...
            <TextInputStyled
              ...
              min={1}
              onChange={(e) =>
                handleCanvasOptionsChange('rowCount', +e.target.value)
              }
            />
          </Col>
          <Col span={12}>
            ...
            <TextInputStyled
              ...
              type="number"
              onChange={(e) =>
                handleCanvasOptionsChange('columnCount', +e.target.value)
              }
            />
          </Col>
        </Row>
        ...
        <Row gutter={24}>
          <Col span={12}>
            ...
            <TextInputStyled
              ...
              min={1}
              onChange={(e) =>
                handleCanvasOptionsChange('cell_width', +e.target.value)
              }
            />
          </Col>
          <Col span={12}>
            ...
            <TextInputStyled
              ...
              type="number"
              onChange={(e) =>
                handleCanvasOptionsChange('cell_height', +e.target.value)
              }
            />
          </Col>
        </Row>
