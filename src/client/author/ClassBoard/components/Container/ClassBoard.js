                ...
                >
                  ...
                  </div>
                  {
                    ...
                    <ClassBoardFeats
                      ...
                      handleTogglePauseStudents={this.handleTogglePauseStudents}
                      handleShowMarkAsAbsentModal={
                        this.handleShowMarkAsAbsentModal
                      }
                      handleShowMarkAsSubmittedModal={
                        this.handleShowMarkAsSubmittedModal
                      }
                      handleShowRemoveStudentsModal={
                        this.handleShowRemoveStudentsModal
                      }
                      handleShowAddStudentsPopup={
                        this.handleShowAddStudentsPopup
                      }
                      disableMarkSubmitted={disableMarkSubmitted}
                      disableMarkAbsent={disableMarkAbsent}
                      actionInProgress={actionInProgress}
                      isProxiedByEAAccount={isProxiedByEAAccount}
                      handleDownloadGrades={this.handleDownloadGrades}
                      enableDownload={enableDownload}
                      lightFadedBlack={lightFadedBlack}
                    />
                  }
                </StickyFlex>
