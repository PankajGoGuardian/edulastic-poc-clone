      ...
      <ResolvedInfoColumsWrapper>
        ...
        {!isStudent ? (
          <SubmittedColumn style={columnStyle}>
            <InfoColumnLabel isAssessment={isAssessment} justify="center" textColor={lightGrey5}>
              SUBMITTED
            </InfoColumnLabel>
            <InfoColumnLabel textColor={greyThemeDark1} padding="4px 0px" justify="center">
              {/* TODO: Method to find submissions */}
              {data?.submitted === "-" ? data?.submitted : `${data?.submitted}%`}
            </InfoColumnLabel>
          </SubmittedColumn>
        ) : (
          <ScoreColumn>
            ...
            <InfoColumnLabel textColor={greyThemeDark1} padding="4px 0px" justify="center">
              ...
              {data?.scores >= 0 && data?.maxScore ? `${data?.scores}/${data?.maxScore}` : "-"}
            </InfoColumnLabel>
          </ScoreColumn>
        )}
        {!isStudent ? (
