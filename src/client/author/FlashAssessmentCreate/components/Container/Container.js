...
import FlashCards from '../../../../assessment/themes/AssessmentPlayerFlashQuiz/FlashCards'
import FlipCards from '../../../../assessment/themes/AssessmentPlayerFlashQuiz/FlipCards'
...
const buttons = [
  ...
  },
  {
    ...
    value: tabs.FLASHREVIEW,
    text: 'Flash View',
  },
  {
    icon: <IconReview color={white} width={24} height={24} />,
    value: tabs.FLIPREVIEW,
    text: 'Flip View',
  },
  {
...
class Container extends React.Component {
  ...
  renderContent() {
    ...
    switch (currentTab) {
      ...
      case tabs.FlASHITEMS:
        return <ItemCards {...props}></ItemCards>
      case tabs.FLASHREVIEW:
        return <FlashCards {...props}></FlashCards>
      case tabs.FLIPREVIEW:
        return <FlipCards {...props}></FlipCards>
      case tabs.SETTINGS:
        return (
          <Setting
            current={currentTab}
