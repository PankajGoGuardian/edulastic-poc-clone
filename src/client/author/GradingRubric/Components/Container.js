...
const Container = ({ actionType, updateRubricData, currentRubricData, closeRubricModal }) => {
  const getContent = () => {
    return <UseExisting closeRubricModal={closeRubricModal} actionType={actionType} />;
  };
