...
export const SET_GENERATED_RUBRIC_INFO = '[rubric] set generate rubric info'
...
export const saveAutoGeneratedRubricAction = createAction(
  SET_GENERATED_RUBRIC_INFO
)
...
export const reducer = createReducer(initialState, {
  ...
  [SET_GENERATED_RUBRIC_INFO]: (state, { payload }) => {
    state.generatedRubricInfo = payload
  },
})
...
function* generateRubricSaga({ payload }) {
  try {
    ...
    yield put(saveAutoGeneratedRubricAction(data))
    notification({ type: 'success', messageKey: 'rubricGeneratedSuccessfully' })
  } catch (err) {
    yield put(setRubricDataLoadingAction(false))
...
export function* watcherSaga() {
  yield all([
    ...
    yield takeEvery(GENERATE_RUBRIC, generateRubricSaga),
  ])
}
...
export const getGeneratedRubricInfoSelector = createSelector(
  getStateSelector,
  (state) => state.generatedRubricInfo
)
