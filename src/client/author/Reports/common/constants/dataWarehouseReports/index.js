...
export const DW_SURVEY_INSIGHTS_URL = `${prefix}/${DW_SURVEY_INSIGHTS_REPORT}`
export const DW_GOALS_AND_INTERVENTIONS_URL = `${prefix}/${DW_GOALS_AND_INTERVENTIONS_REPORT}`
export const DW_EARLY_WARNING_URL = `${prefix}/${DW_EARLY_WARNING_REPORT}`
export const DW_EFFICACY_URL = `${prefix}/${DW_EFFICACY_REPORT}`
