...
export const staticDropDownData = {
  ...
  tagTypes: [
    ...
    { key: 'testTermIds', subType: 'test', tabkKey: '1' },
    { key: 'testSubjects', subType: 'test', tabkKey: '1' },
    { key: 'testGrades', subType: 'test', tabkKey: '1' },
    { key: 'testTypes', tabkKey: '1' },
    { key: 'tagIds', tabkKey: '1' },
    { key: 'testUniqIds', tabkKey: '1' },
    { key: 'student' },
