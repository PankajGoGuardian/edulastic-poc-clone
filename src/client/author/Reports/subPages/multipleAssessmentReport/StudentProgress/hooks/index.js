...
export const useGetBandData = (metricInfo, compareByKey, orgData, selectedTrend, bandInfo) => {
  return useMemo(() => {
    const [parsedData, trendCount] = parseTrendData(metricInfo, compareByKey, orgData, selectedTrend);
