...
import MultipleAssessmentReportFilters from '../filters'
...
jest.mock(
  '../../../../../../common/components/autocompletes/SchoolAutoComplete'
)
jest.mock(
  '../../../../../../common/components/autocompletes/CourseAutoComplete'
)
jest.mock(
  '../../../../../../common/components/autocompletes/TeacherAutoComplete'
)
jest.mock('../../../../../../common/components/autocompletes/ClassAutoComplete')
jest.mock(
  '../../../../../../common/components/autocompletes/GroupsAutoComplete'
)
...
describe('Test type options in the filters modal for Multiple Assessment Report', () => {
  beforeEach(() => {
    cleanup()
    store.clearActions()
  })
  ...
  it('Render the filter component', () => {
    render(
      <Provider store={store}>
        <MultipleAssessmentReportFilters {...props} />
      </Provider>
    )
  })
  ...
  it('should display class assessment in the test type', async () => {
    ...
    const tempStoreData = {
      ...
      reportReducer: {
        ...
        reportMARFilterDataReducer: {
          ...storeData.reportReducer.reportMARFilterDataReducer,
          filters: {
            ...storeData.reportReducer.reportMARFilterDataReducer.filters,
