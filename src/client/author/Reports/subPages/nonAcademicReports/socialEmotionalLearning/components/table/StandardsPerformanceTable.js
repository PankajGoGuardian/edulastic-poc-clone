...
const getDomainColumnRender = (
  ...
  const tooltipTitle = (
    <div>
      ...
      />
      <TableTooltipRow title="Competency: " value={domainName} />
      <TableTooltipRow
...
const onCsvConvert = (data) => downloadCSV(`Social Emotion Learning Insights.csv`, data)
    ...
    <>
      <Row type="flex" justify="start" className={className}>
        <Col xs={24} sm={24} md={11} lg={11} xl={12}>
          <StyledH3>
            Social Emotional Learning summary by {tableFilters.compareBy.title}s
          </StyledH3>
        </Col>
