...
const RESET_REPORTS_STANDARDS_GRADEBOOK = "[reports] reset reports standards gradebook";
...
export const resetStandardsGradebookAction = createAction(RESET_REPORTS_STANDARDS_GRADEBOOK);
...
export const reportStandardsGradebookReducer = createReducer(initialState, {
  [RESET_REPORTS_STANDARDS_GRADEBOOK]: (state, { payload }) => (state = initialState),
