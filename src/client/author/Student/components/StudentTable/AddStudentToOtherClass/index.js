...
function AddStudentsToOtherClass({
  ...
  useEffect(() => {
    const {
      groupInfo: { name, institutionName, primaryTeacherId, owners = [] } = {},
    } = destinationClassData || {}
    let teacherName = ''
    if (primaryTeacherId) {
      ...
      <ConfirmationModal
        ...
        bodyText={
          <div style={{ textAlign: 'center' }}>
            {t('users.student.addtoanotherclass.confirmtext')}
          </div>
        }
        ...
        <Spin spinning={loading}>
          <Form>
            <Field name="destClassCode">
              <FieldLabel>
                {t('users.student.addtoanotherclass.classcode')}
              </FieldLabel>
              <Form.Item>
                {getFieldDecorator('destClassCode', {
                  ...
                  <TextInputStyled
                    onBlur={(evt) =>
                      fetchClassDetailsUsingCode(evt.target.value)
                    }
                  />
                )}
              </Form.Item>
            ...
            <Field name="name">
              <FieldLabel>
                {t('users.student.addtoanotherclass.classname')}
              </FieldLabel>
              <Form.Item>
                {getFieldDecorator('name')(<TextInputStyled disabled />)}
              </Form.Item>
            </Field>
            <Field name="institutionName">
              <FieldLabel>
                {t('users.student.addtoanotherclass.schoolname')}
              </FieldLabel>
              <Form.Item>
            ...
            <Field name="teacherName">
              <FieldLabel>
                {t('users.student.addtoanotherclass.teachername')}
              </FieldLabel>
              <Form.Item>
                {getFieldDecorator('teacherName')(<TextInputStyled disabled />)}
              </Form.Item>
            </Field>
          </Form>
        </Spin>
...
export const AddStudentsToOtherClassModal = Form.create()(
