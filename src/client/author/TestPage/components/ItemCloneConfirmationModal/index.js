...
import { RadioLabel, RadioLabelGroup } from "../../../../assessment/styled/RadioWithLabel";
...
function Modal({ visible, toggleVisibility, handleDuplicateTest }) {
  ...
  return (
    <CloneModal onCancel={handleClose} title={title} visible={visible} centered textAlign="left" footer={footer}>
      <FullHeightContainer>
        <RadioLabelGroup value={cloneOption} onChange={handleChange}>
          ...
          <RadioLabel value="yes">Create a clone of all the items in the test upfront</RadioLabel>
        </RadioLabelGroup>
      </FullHeightContainer>
    </CloneModal>
  );
