...
const ListItem = ({
  ...
  if (
    passagesKeyed[testItem.passageId] &&
    passagesKeyed[testItem.passageId].data
  ) {
    allWidgets = {
      ...questions,
      ...keyBy(passagesKeyed[testItem.passageId].data, 'id'),
    }
  }
  ...
  const handleChangePoint = (qid) => (e) => {
    ...
    if (!testItem.itemLevelScoring && qid) {
      ...
      onChangePoints(metaInfoData.id, itemScore, {
        ...points,
        [qid]: questionScore,
      })
    } else {
            ...
            <FlexContainer>
              ...
              <FlexContainer flexDirection="column">
                ...
                <PointsInput
                  ...
                  value={points}
                  onChange={(e) =>
                    onChangePoints(metaInfoData.id, +e.target.value)
                  }
                />
              </FlexContainer>
            </FlexContainer>
              ...
              <FlexContainer flexDirection="column" style={{ margin: 0 }}>
                ...
                <PointsInput
                  ...
                  onChange={handleChangePoint(
                    get(_item, '[0].widgets[0].reference', null)
                  )}
                />
              </FlexContainer>
              {index === 0 && (
                <PreviewButton onClick={() => onPreview(metaInfoData.id)}>
                  Preview
                </PreviewButton>
              )}
            </FlexContainer>
