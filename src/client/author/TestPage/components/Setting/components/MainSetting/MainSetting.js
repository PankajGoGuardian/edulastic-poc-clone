          ...
          <Col span={isSmallSize ? 24 : 18}>
                ...
                <Body smallSize={isSmallSize}>
                  <Row>
                    ...
                    >
                      ...
                      {Object.keys(
                        isAuthorPublisher ? authorPublisherTestTypes : testTypes
                      ).map((key) => (
            ...
            {availableFeatures.includes(
              ...
              <Block id="require-safe-exame-browser" smallSize={isSmallSize}>
                <Title>
                  ...
                  <Tooltip
                    title="Ensure a secure testing environment by using Safe Exam Browser to lockdown the student's
                  device. To use this feature, Safe Exam Browser (on Windows/Mac/iPad) must be installed on the student
                  device. The quit password can be used by teacher or proctor to safely exit Safe Exam Browser in the 
                  middle of an assessment. The quit password should not be revealed to the students.  If you select 
                  this option, students must use devices (Windows, Mac or iPad) with Safe Exam Browser installed."
                  >
                    <IconInfo
                      color={lightGrey9}
            ...
            {availableFeatures.includes(
              ...
              <Block id="show-answer-choice" smallSize={isSmallSize}>
                ...
                <Body smallSize={isSmallSize}>
                  <Description>
                    {'If set to '}
                    <BlueText>ON</BlueText>, answer choices for multiple choice
                    and multiple select questions will be randomly shuffled for
                    students.
                  </Description>
                </Body>
              </Block>
            ...
            {availableFeatures.includes(
              ...
              <Block id="answer-on-paper" smallSize={isSmallSize}>
                ...
                <Body smallSize={isSmallSize}>
                  <Description>
                    Use this opinion if you are administering this assessment on
                    paper. If you use this opinion, you will have <br /> to
                  ...
                  <Body smallSize={isSmallSize}>
                    <Row gutter={24}>
                      ...
                      <Col span={24} style={{ marginTop: '10px' }}>
                        ...
                        passwordPolicyValues.REQUIRED_PASSWORD_POLICY_STATIC ? (
                          <Description>
                            The password is entered by you and does not change.
                            Students must enter this password before they can
                            take the assessment.
                          </Description>
                        ) : passwordPolicy ===
                          passwordPolicyValues.REQUIRED_PASSWORD_POLICY_DYNAMIC ? (
                          <Description>
                            ...
                            revealed only when the assessment is opened. If you
                            select this method, you also need to specify the
                            time in minutes after which the password would
                            automatically expire. Use this method for highly
                            sensitive and secure assessments. If you select this
                            method, the teacher or the proctor must open the
                            assessment manually and announce the password in
                            class when the students are ready to take the
                            assessment.
                          </Description>
                        ) : (
                          <Description>
                  ...
                  <Row gutter={24}>
                    <Col span={12}>
                      <TextInputStyled
                        disabled={!owner || !isEditable}
                        onChange={(e) =>
                          this.updateTestData('maxAnswerChecks')(e.target.value)
                        }
                        size="large"
              ...
              <Block id="timed-test" smallSize={isSmallSize}>
                ...
                <Body smallSize={isSmallSize}>
                  ...
                  <Description style={{ marginTop: '10px' }}>
                    Select <BlueText> ON </BlueText>, If you want to set a time
                    limit on the test. Adjust the minutes accordingly.
                  </Description>
                </Body>
              </Block>
            )}
            ...
            <AdvancedSettings
              style={{
                display: isSmallSize || showAdvancedOption ? 'block' : 'none',
              }}
            >
