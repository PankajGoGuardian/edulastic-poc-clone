...
describe('Question', () => {
  it('receive question by id should return an action', () => {
    expect(
      receiveQuestionByIdAction('5c0fd3ea025fa415ffeb6895')
    ).toMatchSnapshot()
    expect(
      receiveQuestionByIdAction('5c0fd3ea025fa415ffeb6896')
    ).toMatchSnapshot()
    expect(
      receiveQuestionByIdAction('5c0fd3ea025fa415ffeb6897')
    ).toMatchSnapshot()
  })
