...
export const FETCH_AI_VIEW_DATA_REQUEST = '[gradebook] fetch ai view data request'
export const FETCH_AI_VIEW_DATA_SUCCESS = '[gradebook] fetch ai view data success'
