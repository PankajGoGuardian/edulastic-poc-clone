...
// items
export const RECEIVE_ITEMS_SEARCH_REQUEST = '[itemsSearch] receive items request';
export const RECEIVE_ITEMS_SEARCH_SUCCESS = '[itemsSearch] receive items success';
export const RECEIVE_ITEMS_SEARCH_ERROR = '[itemsSearch] receive items error';
