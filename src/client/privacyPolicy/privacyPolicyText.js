    ...
    <BodyContentWrapper>
      <div>
        ...
        <StyledParagraph>
          ...
          the Offerings and is a binding contract between School (sometimes
          referred to as “School,”“you,” or “your”) and Liminex, Inc. doing
        ...
        <StyledParagraph>IMPORTANT NOTICES:</StyledParagraph>
        <StyledList>
          <li>
        ...
        <StyledParagraph>
          i. We have included, in italics at the beginning of each section,
        ...
        <StyledHeader3 id="heading1">
          1. GETTING ACCESS TO AND STARTED WITH OUR OFFERINGS
        </StyledHeader3>
        <StyledParagraph>
          i. This Section explains how to establish and maintain Account(s).
          This Section describes the importance of being mindful about the
        ...
        <StyledHeader2>1.1 Ordering</StyledHeader2>
        <StyledParagraph>
        ...
        <StyledHeader2>1.2 Accounts</StyledHeader2>
        <StyledParagraph>
        ...
        <StyledHeader2>1.2.1 Authorized Users</StyledHeader2>
        <StyledParagraph>
        ...
        <StyledHeader2>1.2.2 School Information</StyledHeader2>
        <StyledParagraph>
          ...
          accurate, up-to-date and complete Profile Information, and for
        ...
        <StyledHeader2>1.2.3 Account Settings</StyledHeader2>
        <StyledParagraph>
          ...
          Devices or Accounts, please visit, as applicable, the GoGuardian Help
          Center and/or contact support@goguardian.com, or visit the Pear Deck
          Help Center and/or contact support@peardeck.com, or visit the
          Edulastic Help Center and/or contact support@edulastic.com.
        </StyledParagraph>

        <StyledHeader2>1.3 Payment Terms</StyledHeader2>
        <StyledParagraph>
        ...
        <StyledHeader3 id="heading2">2. OFFERINGS</StyledHeader3>
        <StyledParagraph>
          i. This Section explains more about the Offerings, including updates
          to such offerings and linkages with other third party integration
          software that we make available to you. Offerings may experience
          downtime or we may suspend access to Offerings in certain situations.
        </StyledParagraph>
        <StyledHeader2>2.1 Access and Updates to Offerings.</StyledHeader2>
        <StyledParagraph>
        ...
        <StyledHeader2>2.2 Downtime and Suspension of Offerings.</StyledHeader2>
        <StyledParagraph>
        ...
        <StyledHeader2>2.3 Integrations with Offerings.</StyledHeader2>
        <StyledParagraph>
          ...
          Integration Offerings are not “ Offerings” under this Agreement and
          are not subject to any of the warranties, service commitments or other
          ...
          disclose your Profile Information, and, to the extent applicable to
          your Offering, your Authorized School Personnel Information, Personal
          Student Information, Parent/Guardian Information, Association
          Information or other information, including support requests and Log
          and Cookie Information to the extent necessary to utilize the
          Integration Offering. YOUR USE OF ANY INTEGRATION OFFERINGS IS AT YOUR
          OWN RISK AND IS SUBJECT TO ANY ADDITIONAL TERMS, CONDITIONS AND
          POLICIES APPLICABLE TO SUCH INTEGRATION OFFERINGS (SUCH AS TERMS OF
          SERVICE OR PRIVACY POLICIES OF THE PROVIDERS OF SUCH INTEGRATION
          OFFERINGS).
        </StyledParagraph>

        <StyledHeader3 id="heading3">
          3. YOUR USE OF OFFERINGS AND YOUR RESPONSIBILITIES
        </StyledHeader3>
        <StyledParagraph>
          i. This Section explains that Liminex licenses our Offerings to you
          for certain uses. Please use our Offerings responsibly and
          appropriately.
        </StyledParagraph>
        <StyledHeader2>3.1 License Grant to You; Restrictions</StyledHeader2>
        <StyledParagraph>
        ...
        <StyledHeader2>3.2 School Responsibilities</StyledHeader2>
        <StyledParagraph>
        ...
        <StyledHeader2>3.3 General Acceptable Use Policy</StyledHeader2>
        <StyledParagraph>
        ...
        <StyledHeader3 id="heading4">
          4. SPECIAL TERMS FOR FREE, TRIAL AND BETA OFFERINGS
        </StyledHeader3>
        <StyledParagraph>
          i. This Section explains that we may make free, trial, or beta
          offerings available for you to test and provide us with Feedback about
          whether an Offering meets your needs. Because these Offerings are
          different from paid Subscriptions, there are special terms for them.
        </StyledParagraph>
        <StyledHeader2>4.1 Free or Trial Subscriptions</StyledHeader2>
        <StyledParagraph>
        ...
        <StyledHeader2>4.2 Beta Offerings</StyledHeader2>
        <StyledParagraph>
        ...
        <StyledHeader3 id="heading5">5. TERM, TERMINATION</StyledHeader3>
        <StyledParagraph>
          i. This Section explains the duration of this Agreement as well as
          your and our’ obligations after this Agreement ends.
        </StyledParagraph>
        <StyledHeader2>5.1 Term</StyledHeader2>
        <StyledParagraph>
        ...
        <StyledHeader2>5.2 Termination</StyledHeader2>
        <StyledParagraph>
        ...
        <StyledHeader2>5.3 Effect of Termination or Expiration</StyledHeader2>
        <StyledParagraph>
        ...
        <StyledHeader3 id="heading6">6. INTELLECTUAL PROPERTY</StyledHeader3>
        <StyledParagraph>
          i. This Section explains that we ask that you please protect our and
          others’ intellectual property.
        </StyledParagraph>
        <StyledHeader2>6.1 Ownership</StyledHeader2>
        <StyledParagraph>
        ...
        <StyledHeader2>6.2 Feedback</StyledHeader2>
        <StyledParagraph>
        ...
        <StyledHeader2>6.3 Protection of Our Rights</StyledHeader2>
        <StyledParagraph>
        ...
        <StyledHeader3 id="heading7">7. CONFIDENTIALITY</StyledHeader3>
        <StyledParagraph>
          i. This Section explains that each party must respect each other’s
        ...
        <StyledHeader3 id="heading8">8. PRIVACY AND DATA</StyledHeader3>
        <StyledParagraph>
        ...
        <StyledHeader2>8.2 School Privacy Responsibilities</StyledHeader2>
        <StyledParagraph>
        ...
        <StyledHeader2>8.3 Educational Records; FERPA</StyledHeader2>
        <StyledParagraph>
        ...
        <StyledHeader2>8.4 Data-Related Disputes</StyledHeader2>
        <StyledParagraph>
        ...
        <StyledHeader2>8.5 Disclosure of School Information</StyledHeader2>
        <StyledParagraph>
        ...
        <StyledHeader3 id="heading9">9. ALERTS AND NOTIFICATIONS</StyledHeader3>
        <StyledHeader2>
          This section applies to the GoGuardian Offerings only.
        </StyledHeader2>
        <StyledParagraph>
          i. This Section explains that some GoGuardian Offerings are designed
          to generate alerts and/or have other notification features, and that,
        ...
        <StyledParagraph>
          ...
          information changes (e.g., changes in School’s Profile Information,
          its Authorized School Personnel Information, Personal Student
          Information and Parent/Guardian Information (e.g., contact
          information, including an Authorized User’s email address, or changes
          in Parent/Guardian Information ), and Association Information,
          including, for example, the relationship of an Authorized School
          Personnel or a guardian/parent to a child/student changes (e.g.,
          change in guardianship or educational rights holder). Without limiting
          the generality of Section 1.2.1, it is important that you maintain
        ...
        <StyledHeader3 id="heading10">
          10. CONTENT, COPYRIGHT POLICIES, AND COMMUNITY GALLERIES
        </StyledHeader3>
        <StyledParagraph>
          i. This Section explains how content is used in certain Offerings and
          the rights to such content.{' '}
        </StyledParagraph>
        <StyledHeader2>10.1 Content in the Services Generally. </StyledHeader2>
        <StyledParagraph>
        ...
        <StyledHeader2>10.2 License to Your Content </StyledHeader2>
        <StyledParagraph>
          ...
          through, any Offering. By submitting, sharing, uploading, posting, or
          displaying Your Content you hereby grant to Liminex and our Affiliates
        ...
        <StyledHeader2>10.3 Copyright Policies</StyledHeader2>
        <StyledParagraph>
          ...
          copyright infringement is as follows: Copyright Agent Liminex, Inc.
          2030 E Maple Ave, Suite 100 El Segundo, CA 90245
        </StyledParagraph>
        <StyledParagraph>
        ...
        <StyledHeader2>10.4 Third Party Websites and Resources</StyledHeader2>
        <StyledParagraph>
        ...
        <StyledParagraph>
          (A) reproduce Your Gallery Submission or any component thereof;
        </StyledParagraph>
        <StyledParagraph>
        ...
        <StyledParagraph>
          ...
          Edulastic Offerings, you must delete Your Content or change Your
        ...
        <StyledHeader3 id="heading11">
          11. APP STORE SOURCED APPLICATION
        </StyledHeader3>
        <StyledParagraph>
          i. This Section explains terms related to accessing and downloading an
        ...
        <StyledHeader3 id="heading12">
          12. WARRANTIES, DISCLAIMER, AND RELEASE
        </StyledHeader3>
        <StyledParagraph>
          i. This Section explains that we strive to provide you with our
        ...
        <StyledHeader3 id="heading13">13. INDEMNIFICATION</StyledHeader3>
        <StyledParagraph>
        ...
        <StyledHeader3 id="heading14">
          14. LIMITATIONS AND EXCLUSIONS OF LIABILITY
        </StyledHeader3>
        <StyledHeader2>14.1 Disclaimer of Certain Damages</StyledHeader2>
        <StyledParagraph>
        ...
        <StyledHeader2>14.2 Cap on Liability</StyledHeader2>
        <StyledParagraph>
        ...
        <StyledHeader2>14.3 Basis of the Bargain</StyledHeader2>
        <StyledParagraph>
          THE LIMITATIONS OF DAMAGES SET FORTH ABOVE ARE FUNDAMENTAL ELEMENTS OF
          THE BASIS OF THE BARGAIN BETWEEN US AND YOU.
        </StyledParagraph>

        <StyledHeader3 id="heading15">
          15. GOVERNING LAW AND DISPUTE RESOLUTION
        </StyledHeader3>
        <StyledHeader2>15.1 Governing Law and Venue</StyledHeader2>
        <StyledParagraph>
        ...
        <StyledHeader2>15.2.1 Binding Arbitration</StyledHeader2>
        <StyledParagraph>
          Arbitration Rules and Forum Except as otherwise specifically set forth
          below, any Claims between you and us, if unresolved through informal
          consultation and negotiation pursuant to the preceding paragraph,
          shall be resolved by binding arbitration to be held in Los Angeles,
          California. Notwithstanding the foregoing, if School is a United
          States public and accredited educational institution domiciled in a
          state within the United States that expressly requires a different
          location for arbitration other than Los Angeles, California, then
          School’s state’s required location for binding arbitration will apply.
          If School that is a United States public and accredited educational
          institution and your consent to binding arbitration is expressly
          prohibited by the laws of the state within the United States in which
          School’s educational institution is domiciled, then this Section is
          hereby waived. The Federal Arbitration Act governs the interpretation
          and enforcement of this Arbitration Agreement. The arbitration shall
          be conducted by a single arbitrator, governed by JAMS pursuant to its
          Comprehensive Arbitration Rules &amp; Procedures (collectively, “JAMS
          Rules”), as modified by this Agreement, and administered by JAMS. The
          JAMS Rules and fee information are available at www.jamsadr.org or by
          calling JAMS at 1-800-352-5267. The arbitrator shall have exclusive
          ...
          arbitrator will decide the rights and liabilities, if any, of each
          party. The arbitration proceeding will not be consolidated with any
          other matters or joined with any other cases or parties.
        </StyledParagraph>
        <StyledParagraph>
          Exceptions: Litigation of Intellectual Property and Small Claims Court
          Claims Claims concerning patents, copyrights, moral rights,
          trademarks, and trade secrets, and Claims of piracy or unauthorized
          use of any Offering shall not be subject to arbitration under this
          Section 15.2.1. In addition, the parties may choose to pursue a Claim
          in small claims court where jurisdiction and venue over the parties
          otherwise qualify for such small claims court and where the Claim does
          not include a request for any type of equitable relief.
        </StyledParagraph>
        <StyledParagraph>
          Authority of Arbitrator In binding arbitration, the arbitrator shall
          have the authority (a) to grant motions dispositive of all or part of
          any Claim; (b) to award monetary damages; and (c) to grant any
        ...
        <StyledParagraph>
          ...
          but not limited to the award of the arbitrator and compliance
          therewith, shall be strictly confidential. Both parties agree to
          maintain confidentiality unless otherwise required by law. This
          paragraph shall not prevent either party from submitting to a court of
        ...
        <StyledHeader2>15.2.2 Class Action Waiver</StyledHeader2>
        <StyledParagraph>
        ...
        <StyledHeader3 id="heading16">16. MISCELLANEOUS</StyledHeader3>
        <StyledHeader2>16.1 Changes to this Agreement</StyledHeader2>
        <StyledParagraph>
        ...
        <StyledHeader2>16.2 Entire Agreement</StyledHeader2>
        <StyledParagraph>
        ...
        <StyledHeader2>16.3 Language</StyledHeader2>
        <StyledParagraph>
          You agree that this Agreement and all related documents shall be drawn
          up in the English language.
        </StyledParagraph>
        <StyledHeader2>16.4 Severability</StyledHeader2>
        <StyledParagraph>
        ...
        <StyledHeader2>16.5 Force Majeure</StyledHeader2>
        <StyledParagraph>
        ...
        <StyledHeader2>16.6 No Third Party Beneficiaries</StyledHeader2>
        <StyledParagraph>
        ...
        <StyledHeader2>16.7 Electronic Communications</StyledHeader2>
        <StyledParagraph>
        ...
        <StyledHeader2>16.8 Assignment</StyledHeader2>
        <StyledParagraph>
        ...
        <StyledHeader2>16.9 Notice</StyledHeader2>
        <StyledParagraph>
        ...
        <StyledHeader2>16.10 Waiver</StyledHeader2>
        <StyledParagraph>
        ...
        <StyledHeader2>16.11 Export Control</StyledHeader2>
        <StyledParagraph>
        ...
        <StyledHeader3 id="heading17">17. DEFINITIONS</StyledHeader3>
        <StyledParagraph>
        ...
        <StyledParagraph>
          17.1 Add-on means any additional license to an Offering, beyond the
          original Licensed Capacity purchased, the parties agree to add to
          School’s Subscription during a Subscription Term.
        </StyledParagraph>
        <StyledParagraph>
          17.2 Activity Information means information about online account and
          activity collected at the Account level, in connection with Managed
          Devices or Accounts, including, for GoGuardian Offerings, chats
          (within GoGuardian Teacher), a student’s browsing history, IP address
          automatically collected by GoGuardian, online content, screenshots,
          and key input patterns (but not the actual inputs) to identify
          behaviors like gaming, and, for Pear Deck Offerings, information about
          the student’s activity within a presentation, including engagement
          with and any student content generated in the session, and, Your
          Content that is uploaded into or generated in any Offerings. This may
          include free text, multiple choice answers, drawings, or URLs.
        </StyledParagraph>
        <StyledParagraph>
          17.3 Affiliate means any entity that directly or indirectly controls,
          is controlled by, or is under common control with a party. “Control”
          for purposes of this definition means the power to direct or cause the
          direction of the management and policies of the subject entity,
          whether through equity ownership, a credit arrangement, franchise
          agreement or other contractual arrangement.
        </StyledParagraph>
        <StyledParagraph>
          17.4 Applicable Law means any applicable federal and state laws, rules
          and regulations, applicable to the parties and/or the Offerings,
          including but not limited to the Family Educational Rights and Privacy
          Act (“FERPA”), and the Applicable Mental Health Laws.
        </StyledParagraph>
        <StyledParagraph>
          17.5 Applicable Mental Health Law means any federal and state laws,
          rules and regulations applicable to School’s suicide and self-harm
          program and use of GoGuardian Beacon or GoGuardian Admin (self-harm
          smart alerts and/or Beacon Starter), including applicable law
          mandating staff training, certain suicide staff roles such as suicide
          prevention coordinators, and school prevention, intervention, and
          post-intervention policies.
        </StyledParagraph>
        <StyledParagraph>
          17.6 Association Information means information associating a
          particular student or other user of a Managed Device or Account to a
          particular Managed Device or Account, as well as information about
          associations between any such user of a Managed Device or Account with
          School, an organizational unit or other grouping within the school
          (e.g., grade, class, cohort), a parent or guardian or a school
          official or Authorized School Personnel. Association Information does
          not include Activity Information.
        </StyledParagraph>
        <StyledParagraph>
          17.7 Authorized Reseller means an entity authorized by Liminex or one
          of its Affiliates to sell Subscriptions to one or more Offerings under
          the terms of this Agreement and with which School has contracted
          directly to purchase the Offerings.
        </StyledParagraph>
        <StyledParagraph>
          17.8 Authorized User means an individual who is authorized by School
          to use an Offering, for whom School has purchased or provisioned a
          Subscription, and to whom School (or, when applicable, Liminex or one
          of its Affiliates, at School’s request) has supplied access
          credentials (for Offerings utilizing authentication). Authorized Users
          include, for example, Authorized School Personnel and agents and third
          parties such as students and parents/guardians.
        </StyledParagraph>
        <StyledParagraph>
          17.9 Authorized School Personnel means an Authorized User who is an
          employee, teacher, or official of a School or a School’s district.
        </StyledParagraph>
        <StyledParagraph>
          17.10 Authorized School Personnel Information means information about
          Authorized School Personnel, including permission levels associated
          with the Authorized School Personnel, chat messages between students
          and teachers using an Offering, such as GoGuardian Teacher, unique
          account identifiers generated by a us, and other relevant unique
          identifiers.
        </StyledParagraph>
        <StyledParagraph>
          17.11 Confidential Information means (a) any software utilized by us
          in the provision of any Offering and its respective source code; (b)
          each party’s business or technical information, including but not
          limited to the User Documentation, information relating to software
          plans, designs, costs, prices and names, business opportunities,
          ...
          and (c) any special pricing or other non-standard terms agreed to by
          the parties in an Order Form or other separate written document.
          Confidential Information will not include any information that: (w) is
          or becomes generally known to the public without breach of any
          obligation owed to the disclosing party; (x) was known to a party
          prior to its disclosure by the other party without breach of any
          obligation owed to the other party; (y) was independently developed by
          a party without breach of any obligation owed to the other party; or
          (z) was or is received from a third party without breach of any
          obligation owed to the other party.
        </StyledParagraph>
        <StyledParagraph>
          17.12 Deidentified Information means aggregated and anonymized data
          which may be derived from School Account Information, Personal Student
          Information, Parent/Guardian Information, School Log and Cookie
          Information, or Activity Information; provided such Deidentified
          Information cannot reasonably be used to identify any Authorized User,
          user of a Managed Device or Account, or any other individual.
        </StyledParagraph>
        <StyledParagraph>
          17.13 Education Records means “education records” as defined under the
          FERPA regulation 34 CFR § 99.3.
        </StyledParagraph>
        <StyledParagraph>
          17.14 Account means an account created by or on behalf of School that
          is associated with one or more Offerings for which School has a
          Subscription, which is then used by School to manage access and use of
          the Offering(s) by School and its Authorized Users.
        </StyledParagraph>
        <StyledParagraph>
          17.15 Liminex Information means (a) all Deidentified Information; and
          (b) any information collected by Liminex or its Affiliates
        ...
        <StyledParagraph>
          17.16 Offering mean any product or service, including Professional
          Services, made available by Liminex or its Affiliates, including the
          GoGuardian Offerings, the Pear Deck Offerings, and the Edulastic
          Offerings.
        </StyledParagraph>
        <StyledParagraph>
          17.17 GoGuardian Offering(s) means Liminex’s suite of products and
          services, including Professional Services, provided under the
          GoGuardian brand, other than the Websites.
        </StyledParagraph>
        <StyledParagraph>
          17.18 Pear Deck Offering(s) means Liminex’s suite of products and
          services, including Professional Services, provided under the Pear
          Deck brand, other than the Websites.
        </StyledParagraph>
        <StyledParagraph>
          17.19 Edulastic Offering(s) means Liminex’s suite of products and
          services, including Professional Services, provided under the
          Edulastic brand, other than the Websites.
        </StyledParagraph>
        <StyledParagraph>
          17.20 Liminex Parties means Liminex, its Affiliates, including Pear
          Deck and Edulastic, and each of their respective licensors, suppliers,
          officers, directors, employees, shareholders, agents and
          representatives.
        </StyledParagraph>
        <StyledParagraph>
          17.21 Licensed Capacity means the number of licenses to an Offering
          covered by a Subscription during a Subscription Term (e.g., depending
          on the particular offering, the number of accounts, authorized
          devices, installations, seats).
        </StyledParagraph>
        <StyledParagraph>
          17.22 Managed Device or Account means any device and/or account of a
          student or user for which School deploys or installs an Offering or
          seeks participation from an Offering for such purpose in accordance
          with the terms of this Agreement.
        </StyledParagraph>
        <StyledParagraph>
          17.23 Order Form means a written or online ordering document,
          communication, form, statement of work, or other documentation that
          specifies the Offering(s) to be provided and which is either executed
          or submitted by you, and then accepted by a Liminex, one of its
          Affiliates or one of their Authorized Resellers. Each Order Form
          identifies the purchased Offering(s), any applicable fees, and, for
          licensed products and services, the Subscription Term and Licensed
          Capacity, as well as any other terms as agreed to between the parties.
          If an Order Form with School indicates that any School Affiliates will
          be receiving access to the Offering(s) hereunder, each of them will be
          bound by the terms of this Agreement as if they were an original party
          hereto.
        </StyledParagraph>
        <StyledParagraph>
          17.24 Parent/Guardian Information means any data or information
          provided, submitted, or made available in an Offering about a parent
          or guardian of a student user of a Managed Device or Account,
          including the individual’s association with a particular child and his
          or her contact information (e.g., email address).
        </StyledParagraph>
        <StyledParagraph>
          17.25 Content means all information (such as data files, fonts,
          written text, computer software, music, audio files, image files or
          other sounds, photographs, videos or other images) which you may have
          access to as part of, or through your use of, any Offerings.
        </StyledParagraph>
        <StyledParagraph>
          17.26 Personal Student Information means information provided,
          submitted, or made available in an Offering about a student user of a
          Managed Device or Account (including, the student’s School-managed
          account information, Activity Information, grade and attendance data,
          and location information to the extent collected) that may, alone or
          in combination with other available information, be reasonably used to
          identify a current or former student enrolled in a K-12 School,
          including Educational Records defined herein.
        </StyledParagraph>
        <StyledParagraph>
          17.27 Professional Services means any supplemental technical,
          training, support, consulting or implementation services that Liminex
          or one of its Affiliates provides to you, as set forth in an Order
          Form. Any purchased Professional Services, whether provisioned in
          connection with or support of another GoGuardian Offering or Pear Deck
          Offering, shall be deemed an Offering hereunder.
        </StyledParagraph>
        <StyledParagraph>
          17.28 School means the school, school district, corporation,
          organization or other legal entity identified on an Order Form on
          whose behalf the individual accepts this Agreement and, and any
          Affiliates of that school, school district, corporation, organization
          or other legal entity have entered into Order Form(s) (for so long as
          they remain Affiliates).
        </StyledParagraph>
        <StyledParagraph>
          17.29 School Account Information means Profile Information, Authorized
          School Personnel Information, and Association Information.
        </StyledParagraph>
        <StyledParagraph>
          17.30 School Affiliate means any Affiliate of School that has been
          designated in an Order Form as authorized to access the Offerings
          under this Agreement.
        </StyledParagraph>
        <StyledParagraph>
          17.31 School Log and Cookie Information means analytics, log and event
          information, such as IP address, Internet service provider (ISP), date
          and time stamp, browser language, browser type, amount of time spent
          on particular portions of the Offerings, service diagnostics and
          technical logging information, device information, and/or other
          general usage data, automatically collected by or on behalf of Liminex
          or an Affiliate.
        </StyledParagraph>
        <StyledParagraph>
          17.32 School Profile Information means the name, email address, and
          phone number of the individual ordering the Offering on School’s
          behalf, as well as the School’s name, address, billing address, of the
          School or Authorized User, as applicable, the number of devices,
          number of students, and network configuration, and to the extent an
          Account is created for School, the password created for such Account.
        </StyledParagraph>
        <StyledParagraph>
          17.33 Subscription means a time-limited right granted to School to
          access and use one or more licenses to an Offering under the terms of
          this Agreement.
        </StyledParagraph>
        <StyledParagraph>
          17.34 Subscription Term means the period of time for which you
          subscribe (whether through a standard license or as part of a trial or
          beta license) to a particular Offering, as specified in an Order Form.
          For the avoidance of doubt, “Subscription Term” includes the initial
          Subscription Term agreed to in the Order Form and any subsequent
          renewal Subscription Term under that Order Form.
        </StyledParagraph>
        <StyledParagraph>
          ...
          the Edulastic <a href="/help-center/">Help Center</a>, or such other
          URL we identify from time to time, and any other materials we provide
          as part of the Offerings, all as may be updated from time to time.
        </StyledParagraph>
        <StyledParagraph>
          17.36 Website(s) means the Liminex or its Affiliates’ websites made
          available online to the public that are not the Offerings.{' '}
        </StyledParagraph>
      </div>
    </BodyContentWrapper>
  )
