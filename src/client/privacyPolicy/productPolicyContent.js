...
const ProductPolicyContent = () => {
  return (
    <BodyContentWrapper data-testid="productPrivacyPolicy">
      ...
      <div>
        <h3 id="heading1">Introduction</h3>
        <p>
          Welcome! GoGuardian (formally — Liminex, Inc. doing business as
          GoGuardian)&nbsp; and its family of company Affiliates including Pear
          Deck, Inc. (“Pear Deck”) and Edulastic (formally – Snapwiz, Inc. doing
          business as Edulastic — referred to throughout as “Edulastic”)
          (together, Liminex, Inc. dba GoGuardian, Pear Deck, and Edulastic as
          “Liminex”, “we”, “us”, “our”) is an educational technology company
          that provides K-12 schools and school districts with digital learning
          tools designed to supercharge the learning potential of every
          student.&nbsp; The privacy of each and every user matters deeply to
          us, and we strive for transparency in all of our data privacy
          practices—especially when it comes to identifying the information that
          we collect, use, share, and disclose, as well as how we help keep your
          information safe. We take our responsibility to protect your
          information very seriously. Please remember that we are always here to
          answer any questions you have, and we look forward to working with you
          for years to come. Capitalized terms used herein that are not
          expressly defined are as defined in our{' '}
          <a
        ...
        <p>
          ...
          European Economic Area (“EEA”), our Data Protection Addendum (“DPA”),
          also apply to how we treat your information.
        </p>
        <h4>Information Provided Directly to Us through our Offerings</h4>
        <p>
        ...
        <h4>School and School Official Information</h4>
        <p>
        ...
        <ul>
          <li>
            ...
            (“School Official”) initiates contact through our Website for the
            Offerings on behalf of his/her School, we collect that School
            Official’s contact information as well as information about his/her
            School relevant to purchasing and setting up our&nbsp; Offerings.
            This information includes the School Official’s name, email address,
          ...
          <li>
            ...
            “Authorized School Personnel”) from their School and designate their
            appropriate permission levels in the Offerings. Certain Offerings
            require the School Official and/or their Authorized School Personnel
            to provide class enrollment information (e.g., class name and
            subject).
          </li>
          <li>
        ...
        <h4>Personal Student Information for All Offerings</h4>
        <p>
        ...
        <h4>GoGuardian Personal Student Information</h4>
        <p>
        ...
        <h4>Pear Deck Personal Student Information</h4>
        <p>
        ...
        <h4>Edulastic Personal Student Information</h4>
        <p>
        ...
        <ul>
          ...
          <li>
            ...
            facilitate such integration, including unique identifiers (e.g., SIS
        ...
        <h4>Information We Automatically Collect through Our Offerings</h4>
        <p>
        ...
        <h4>How We Use Information Collected Through Our Offerings</h4>
        <p>
        ...
        <p>
          ...
          99.3) (“FERPA”), California Business &amp; Professions Code section
          22584 (“SOPIPA”), and California Education Code section 49073.1. We
          will not use Personal Student Information for any purpose other than
          those required or specifically set forth in this Product Privacy
          Policy, our{' '}
          <a
            href="https://edulastic.com/terms-of-service/"
            target="_blank"
        ...
        <p>
          ...
          please see the “Notice to EEA and Other Non-US Residents” section for
          more information about how we use information and the legal bases for
          collecting information.
        </p>
        <h4>How We Share Information Collected Through Our Offerings</h4>
        ...
        <ul>
          ...
          <li>
            ...
            our Offerings. When we employ another company to perform a function
            of this nature, we provide them with the information that they need
            to perform their specific function.
          </li>
          <li>
            <em>With School Permission or at School Direction:</em> We may share
            or disclose information, including Personal Student Information, to
          ...
          <li>
            <em>Protection of Liminex and Others:</em> We may share or disclose
            certain of the information we collect (set forth above) if we
            believe in good faith that doing so is necessary or appropriate to
            (i) protect or defend the rights, safety, or property of Liminex or
          ...
          <li>
            ...
            information we collect (set forth above), in connection with or
            during negotiations of any merger, sale of company assets,
            financing, or acquisition of all or a portion of our business to
            another company. If such transfer is subject to additional mandatory
            restrictions under applicable laws, we will comply with such
            restrictions. The successor entity will be subject to all applicable
            federal and state laws, including student privacy laws. In
            connection with such a transaction, we will also work to ensure that
            the successor entity has a commitment to student privacy.
          </li>
          <li>
        ...
        <p>
          ...
          as required or permitted by law. To dispose of any personal
        ...
        <h4>Your Choices about Information Collected through Our Offerings</h4>
        <p>
        ...
        <ul>
          ...
          <li>
            <em>California Rights:</em> Effective January 1, 2020, under the
            California Consumer Privacy Act (“CCPA”) , California residents may
            annually request a list of the third parties to which a company
            discloses “personal information” (as defined in the CCPA) for such
            third parties’ marketing purposes and the types of information
            disclosed. However, we do not disclose personal information to third
            parties for such third parties’ direct marketing purposes. The CCPA
            offers certain rights for California residents with respect to
            personal information, but these rights do not apply to business to
            business information nor to personal information collected by
            GoGuardian when GoGuardian is acting as a service provider of a
            School (e.g., business contact, contract and communications
            information are excluded from CCPA rights. You can read more about
            any such applicable CCPA rights at our Privacy Policy for Website
            visitors. However, even though the CCPA rights may not apply to your
            data request, if you are acting on behalf of your School and would
            like to submit a data request, rather than submit a CCPA request,
            please instead follow the instructions described in the Section
            titled “School’s Request for Deletion or Transfer of Personal
            ...
            data request to us, rather than submit a CCPA request, please
            instead follow the instructions described in the Section titled
            “Requests from Parents, Legal Guardians, Eligible Students, and
            Authorized School Personnel.”
          </li>
          <li>
            <em>Your Legal Rights Under Local Law: </em>Local laws (e.g., laws
            of the European Union) may permit an individual to request that we:
            (1) provide access to and/or a copy of certain information that we
            ...
            delete certain information that we are holding about an individual;
            (5) restrict the way that we process and disclose certain of the
            individual’s information; (6) transfer an individual’s information
            to a third party provider of services; and/or (7) revoke an
            individual’s consent for the processing of his/her information. If
            your local laws provide additional rights, we will consider all
            requests and provide our response within the time period stated by
            applicable law. Please note, however, that certain information may
            be exempt from such requests in some circumstances, which may
            include if we need to continue processing an individual’s
            ...
            please contact us as described further in the “How to Contact Us”
            section below. In addition to those rights, an individual has the
            right to lodge a complaint with the relevant supervisory authority.
            However, we encourage the individual to contact us first, and we
            will do our very best to resolve the individual’s concern.
          </li>
        </ul>
        <p>
        ...
        <ul>
          ...
          <li>
            ...
            <ul>
              <li>
                ...
                deletion of Personal Student Information or School Information,
                he/she should contact the appropriate School Official of his/her
                or his/her child’s School. We will cooperate with the School to
                fulfill requests pursuant to the School’s verification and
                instruction within a commercially reasonable amount of time and
                in compliance with relevant law.
              </li>
              <li>
                Parent App: If you are a user of the Parent App, you can review
                information about the choices you may have with respect to the
                personal information you provide through the Parent App in the “
                <a
                  href="https://www.edulastic.com/privacy-policy-for-website-visitors/#heading1_7"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Your Choices
                ...
                ” section of our{' '}
                <a
                  href="https://www.edulastic.com/privacy-policy-for-website-visitors/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
              ...
              <li>
                If you are Authorized School Personnel, please note that we may
                be required to maintain certain School Information if directed
                to do so by your School Official on behalf of your School
                employer or as needed by us to enforce our legal rights.
              </li>
            </ul>
          </li>
          <li>
            <em>Transfer Requests.</em> Our Offerings allow Authorized School
            Personnel to download information on behalf of a parent, legal
            guardian, eligible student, or School Personnel. If our Offerings do
            not cover the scope of the transfer request, we will, following
            documented instructions from the School, honor the requests from the
            parent, legal guardian, eligible student, or Authorized School
          ...
          <li>
            <em>Transfer Requests for Student-Generated Content. </em>California
            law requires website operators to transfer student-generated content
            ...
            extent that students in California, or in other states with similar
            ...
            him/her. Following verification of the requestor’s authorization to
            ...
            that we have in a commercially reasonable amount of time in either a
            CSV or other mutually-agreeable format. Please note that we cannot
        ...
        <h3 id="heading2">NOTICE TO E.E.A. AND OTHER NON-U.S. RESIDENTS</h3>
        <p>
        ...
        <h4>Liminex as a Data Controller vs. Data Processor</h4>
        <p>
          ...
          School controller, pursuant to our EULA and, if applicable, DPA. If
          you have a question or complaint about how your personal data is
        ...
        <h4>How To Contact Us and Dispute Resolution</h4>
        <p>
        ...
        <h3 id="heading3">Cookies Notice</h3>
        <p>
        ...
        <p>
          <i>What types of Cookies do we use and what data do they collect?</i>
        </p>
        <p>
        ...
        <p>
          <i>What are my choices about Cookies?</i>
        </p>
        <p>
