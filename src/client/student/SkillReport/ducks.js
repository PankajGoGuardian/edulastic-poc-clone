...
export const LOAD_SKILL_REPORT_BY_CLASSID_SUCCESS = "[reports] load skill report by class id success";
export const LOAD_SKILL_REPORT_BY_CLASSID_FAILED = "[reports] load skill report by class id failed";
...
function* fetchSkillReport(action) {
  ...
  try {
    ...
    yield put({ type: LOAD_SKILL_REPORT_BY_CLASSID_SUCCESS, payload: { reports } });
  } catch (err) {
