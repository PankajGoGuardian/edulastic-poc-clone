        ...
        <RegistrationWrapper>
          <RegistrationHeader type="flex" align="middle">
            ...
            <Col span={12} align="right">
              <span>{t('component.signup.teacher.alreadyhaveanaccount')}</span>
            ...
            <Col xs={18} offset={3}>
              <Row type="flex" align="middle">
                ...
                <Col xs={24} sm={14} md={13} lg={12} xl={10}>
                  <FormWrapper>
                    <FormHead>
                      <h3 align="center"><b>{t('component.signup.teacher.signupboxheading')}</b></h3>
                      <ThirdPartyLoginBtn span={20} offset={2}><img src={googleIcon} alt="" /> {t('component.signup.teacher.googlesignupbtn')}</ThirdPartyLoginBtn>
                      <ThirdPartyLoginBtn span={20} offset={2}><img src={icon365} alt="" /> {t('component.signup.teacher.office365signupbtn')}</ThirdPartyLoginBtn>
                    ...
                    <FormBody>
                      <Col span={20} offset={2}>
                        <h5 align="center">{t('component.signup.teacher.formboxheading')}</h5>
                        <Form onSubmit={this.handleSubmit}>
                          ...
                          <FormItem {...formItemLayout} label={t('component.signup.teacher.signuppasswordlabel')}>
