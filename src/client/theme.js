...
const rightIconColor = "#D3FEA6";
const wrongIconColor = "#FCE0E8";
...
export const defaultTheme = {
  ...
  sideMenu: {
    ...
    userInfoDropdownBgColor: labelBgColorOverlayingContainer,
    userInfoDropdownItemBgColor: buttonBackgroundColor,
    userInfoDropdownItemBgHoverColor: buttonBackgroundHoverColor,
    userInfoDropdownItemTextColor: labelStyle,
  ...
  common: {
    ...
    mathInputMathWrongBgColor: wrongIconColor,
  ...
  questionMetadata: {
    ...
    antSelectSelectionSelectedValueFontSize: subtitleFontSize,
  ...
  widgets: {
    classification: {
      ...
      dragItemNotValidBgColor: wrongIconColor,
      dragItemBorderColor: borderColor,
      dragItemValidBorderColor: rightIconColor,
      dragItemNotValidBorderColor: wrongIconColor,
    ...
    essayPlainText: {
      ...
      textInputLimitedBgColor: wrongIconColor,
    ...
    essayRichText: {
      ...
      quillLimitedBgColor: wrongIconColor,
    ...
    mathFormula: {
      ...
      inputIncorrectColor: wrongIconColor,
    ...
    hotspot: {
      ...
      intersectFillColor: wrongIconColor,
      iconPlusColor: actionIconColor,
    ...
    tokenHighlight: {
      ...
      incorrectResultBgColor: wrongIconColor,
    ...
    matchList: {
      ...
      dragItemIncorrectBgColor: wrongIconColor,
      dragItemBorderColor: borderColor,
    ...
    matrixChoice: {
      ...
      incorrectCellInputWrapperBgColor: wrongIconColor,
    ...
    multipleChoice: {
      ...
      labelWrongBgColor: wrongIconColor,
    ...
    orderList: {
      ...
      incorrectContainerBgColor: wrongIconColor,
    ...
    sortList: {
      ...
      dragItemCorrectTextBgColor: rightIconColor,
      dragItemIncorrectTextBgColor: wrongIconColor,
    ...
    assessmentPlayers: {
      ...
      sidebarContentBorderColor: "none",
  ...
  classCard: {
    ...
    cardHeaderBorderColor: borderColor,
    cardTitleColor: themeColor,
    ...
    cardActiveStatusTextSize: themeColor,
